...
<i18n lang="yaml">
{
  ...
  ru: {
    m_title: "Конвертер LESS в CSS онлайн — бесплатно и мгновенно",
    title: "Конвертер LESS в CSS",
    meta: "Конвертируйте LESS в CSS онлайн бесплатно. Вставьте LESS-код и получите готовый валидный CSS без необходимости установки инструментов сборки.",
    d1: "LESS — это препроцессор CSS, расширяющий возможности языка за счет переменных, вложенных правил, примесей (mixins) и функций, что делает таблицы стилей более удобными в поддержке и повторном использовании. Однако браузеры понимают только обычный CSS, поэтому LESS должен быть скомпилирован перед развертыванием.",
    bt: "Конвертировать",
    rst: "Начать заново",
    copy: "Копировать",
    plc: "Вставьте код LESS сюда или перетащите файл",
    err: "Ошибка",
    err_label: "Ошибка компиляции",
    how_it_works_title: "Как это работает",
    hiw_1_title: "Вставьте LESS",
    hiw_1_desc: "Вставьте или перетащите файл LESS в редактор. Переменные, примеси (mixins) и вложенность полностью поддерживаются.",
    hiw_2_title: "Нажмите «Конвертировать»",
    hiw_2_desc: "Нажмите кнопку «Конвертировать», и инструмент мгновенно скомпилирует ваш LESS прямо в браузере.",
    hiw_3_title: "Скопируйте CSS",
    hiw_3_desc: "Скомпилированный CSS отобразится в редакторе. Нажмите кнопку «Копировать CSS», чтобы сохранить его в буфер обмена.",
    use_cases_title: "Варианты использования",
    uc_1_title: "Быстрое тестирование фрагментов",
    uc_1_desc: "Мгновенно тестируйте переменные, примеси или правила вложенности LESS без настройки локальной среды сборки.",
    uc_2_title: "Отладка стилей",
    uc_2_desc: "Изолируйте и отлаживайте отдельные блоки LESS, чтобы понять итоговый сгенерированный CSS и легко находить ошибки.",
    uc_3_title: "Миграция кода",
    uc_3_desc: "Преобразуйте существующие таблицы стилей LESS в чистый CSS при переносе проектов и отказе от препроцессоров.",
    faq_title: "Вопросы и ответы",
    faq_1_q: "Отправляется ли мой код LESS на сервер?",
    faq_1_a: "Нет. Компиляция выполняется полностью внутри вашего браузера. Ваш код никогда не покидает ваше устройство.",
    faq_2_q: "Поддерживаются ли все возможности LESS?",
    faq_2_a: "Да. Переменные, примеси, вложенность, функции, импорты из встроенных определений и большинство других функций языка LESS поддерживаются в полном объеме.",
    faq_3_q: "Что произойдет, если в моем LESS-коде будет ошибка?",
    faq_3_a: "Инструмент выведет подробное описание ошибки компиляции, чтобы вы могли быстро локализовать и устранить проблему.",
    see1: "XML → JSON",
    see2: "JSON → XML",
    see3: "Системы счисления",
    see4: "Единицы хранения",
    f_1: "Мгновенная компиляция LESS в CSS",
    f_2: "Поддержка переменных, примесей и вложенности",
    f_3: "Отображение ошибок компиляции в реальном времени",
