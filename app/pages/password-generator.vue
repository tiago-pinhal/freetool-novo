...
<i18n lang="yaml">
{
  ...
  nl: {
    pageTitle: "Wachtwoord Generator — Sterk & Veilig Wachtwoord Maken | Gratis",
    title: "Wachtwoordgenerator",
    meta: "Gratis wachtwoord generator online. Maak direct sterke, willekeurige wachtwoorden. Pas lengte, symbolen en cijfers aan en controleer de sterkte in realtime.",
  ...
  ru: {
    pageTitle: "Генератор надежных паролей — создать случайный пароль онлайн | Бесплатно",
    title: "Генератор паролей",
    meta: "Бесплатный генератор надежных паролей. Создавайте безопасные случайные пароли мгновенно. Настраивайте длину, использование символов, цифр и заглавных букв. Проверяйте сложность пароля в реальном времени.",
    upp: "Заглавные буквы (A-Z)",
    low: "Строчные буквы (a-z)",
    num: "Цифры (0-9)",
    sym: "Специальные символы (!#${'@'}...)",
    len: "Длина",
    bt: "Сгенерировать пароль",
    pass: "Ваш пароль",
    strength: "Сложность",
    str_0: "Очень слабый",
    str_1: "Слабый",
    str_2: "Средний",
    str_3: "Надежный",
    str_4: "Очень надежный",
    copy: "Копировать пароль",
    placeholder: "Нажмите «Сгенерировать», чтобы создать пароль",
    use_cases_title: "Варианты использования",
    uc_1_title: "Онлайн-аккаунты",
    uc_1_desc: "Создавайте уникальные, защищенные от взлома пароли для социальных сетей и электронной почты.",
    uc_2_title: "Финансовая безопасность",
    uc_2_desc: "Защитите свои банковские и финансовые приложения паролями максимальной сложности.",
    uc_3_title: "Работа и бизнес",
    uc_3_desc: "Соблюдайте правила корпоративной безопасности, используя случайные пароли профессионального уровня.",
    uc_4_title: "Локальное шифрование",
    uc_4_desc: "Обеспечьте безопасность сетей Wi-Fi, личных устройств и зашифрованных локальных файлов.",
    how_it_works_title: "Как это работает",
    step_1_title: "Настройка",
    step_1_desc: "Выберите типы символов (заглавные, строчные, цифры, специальные символы) и длину пароля.",
    step_2_title: "Генерация",
    step_2_desc: "Нажмите кнопку «Сгенерировать пароль», чтобы мгновенно создать надежный пароль.",
    step_3_title: "Проверка и использование",
    step_3_desc: "Проверьте индикатор надежности и скопируйте полученный результат в буфер обмена.",
    faq_title: "Вопросы и ответы",
    faq_1_q: "Безопасно ли генерировать пароли онлайн?",
    faq_1_a: "Да. Наш генератор работает полностью в вашем браузере. Пароли создаются локально на вашем устройстве и никогда не отправляются на серверы.",
    faq_2_q: "Как создать надежный пароль?",
    faq_2_a: "Надежный пароль должен состоять как минимум из 12 символов и включать комбинацию заглавных и строчных букв, цифр и специальных знаков. Избегайте использования обычных слов.",
    faq_3_q: "Что делает пароль слабым?",
    faq_3_a: "Недостаточная длина (менее 8 символов), использование простых слов (например, «admin») или предсказуемых последовательностей (например, «123456»).",
    faq_4_q: "Нужно ли часто менять пароли?",
    faq_4_a: "Рекомендуется периодически менять пароли для важных аккаунтов или делать это немедленно при подозрении на утечку данных.",
    see1: "Редактор PDF",
    see3: "Калькулятор часов",
