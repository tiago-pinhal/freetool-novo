...
<i18n lang="yaml">
{
  ...
  en: {
    ...
    meta: "Generate valid fictitious credit card numbers for software testing and QA. Supports Visa, Mastercard, Amex and more, with Luhn Algorithm validation. Includes name, expiry date and CVV.",
    brands: "Card Brand",
    num: "Card Number",
    name: "Cardholder",
    dt: "Expiry",
    ...
    d1: "Generate complete fictitious credit cards (number, cardholder, expiry and CVV) for checkout testing, QA and integration with payment gateways. The numbers follow the real structure with BIN prefix and Luhn verification, but are entirely fictitious and do not work in real transactions.",
  ...
  es: {
    ...
    meta: "Genera números de tarjeta de crédito ficticios válidos para pruebas de software y QA. Compatible con Visa, Mastercard, Amex y más, con validación por el Algoritmo de Luhn. Incluye nombre, vencimiento y CVV.",
    brands: "Marca",
  ...
  fr: {
    ...
    meta: "Générez des numéros de carte de crédit fictifs valides pour les tests logiciels et QA. Compatible avec Visa, Mastercard, Amex et plus, avec validation par l'Algorithme de Luhn. Inclut nom, date d'expiration et CVV.",
    brands: "Réseau",
    num: "Numéro de Carte",
    name: "Titulaire",
    dt: "Expiration",
  ...
  it: {
    ...
    meta: "Genera numeri di carta di credito fittizi validi per test software e QA. Supporta Visa, Mastercard, Amex e altri, con validazione dall'Algoritmo di Luhn. Include nome, scadenza e CVV.",
    brands: "Circuito",
    num: "Numero di Carta",
    name: "Titolare",
    dt: "Scadenza",
