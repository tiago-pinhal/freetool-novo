...
ru:
  title: "Редактор PDF"
  page_title: "Бесплатный онлайн PDF-редактор — объединение, удаление и изменение порядка страниц"
  meta: "Бесплатный онлайн PDF-редактор: объединяйте файлы, удаляйте страницы, поворачивайте и меняйте их порядок. Локальная обработка: ваши файлы никогда не покидают ваше устройство."
  intro: "PDF-редактор позволяет объединять несколько PDF-файлов в один документ, удалять ненужные страницы, поворачивать отдельные страницы и свободно менять их порядок. Вся обработка происходит прямо в вашем браузере, без установки программ и загрузки файлов на серверы, что гарантирует полную конфиденциальность."
  upload_hint: "Выберите один или несколько PDF-файлов для начала работы"
  click_upload: "Нажмите для загрузки"
  or_drag: "или перетащите их сюда"
  ...
  expand: "Увеличить страницу"
  close: "Закрыть"
  drag_hint: "Перетаскивайте страницы, чтобы изменить их порядок перед скачиванием"
  question: "Вы уверены, что хотите удалить эту страницу?"
  confirm: "Удалить"
  cancel: "Отмена"
  err: "Произошла ошибка при попытке открыть файл"
  err_pass: "PDF-файл защищен паролем"
  features_title: "Возможности PDF-редактора"
  feature_1: "Объединение двух или более PDF-файлов в один документ"
  feature_2: "Удаление ненужных страниц в один клик"
  feature_3: "Поворот отдельных страниц влево или вправо"
  feature_4: "Изменение порядка страниц простым перетаскиванием"
  use_cases_title: "Когда использовать PDF-редактор"
  use_cases_desc: "Онлайн PDF-редактор идеально подходит для тех, кому нужно быстро отредактировать цифровые документы без установки программ или покупки дорогого софта."
  uc_1_title: "Объединение PDF-файлов"
  uc_1_desc: "Объединяйте отдельные договоры, отчеты или презентации в один PDF-файл для удобства отправки и архивирования."
  uc_2_title: "Очистка документов"
  uc_2_desc: "Удаляйте пустые страницы, ненужные обложки или конфиденциальную информацию перед отправкой PDF."
  uc_3_title: "Исправление ориентации"
  uc_3_desc: "Поворачивайте отсканированные страницы, которые оказались перевернутыми или в неправильной ориентации, прямо в браузере."
  uc_4_title: "Изменение структуры"
  uc_4_desc: "Меняйте порядок страниц PDF-файла, чтобы они следовали в нужном порядке, без необходимости собирать документ заново с нуля."
  how_to_title: "Как использовать PDF-редактор"
  how_1_title: "Загрузите ваши PDF-файлы"
  how_1_desc: "Нажмите для загрузки или перетащите один или несколько PDF-файлов. Вы сможете добавить другие PDF-файлы позже, чтобы объединить их."
  how_2_title: "Отредактируйте страницы"
  how_2_desc: "Поворачивайте, удаляйте или перетаскивайте миниатюры страниц, чтобы изменить их порядок. Все изменения сразу видны перед скачиванием."
  how_3_title: "Скачайте готовый файл"
  how_3_desc: "Нажмите «Скачать», чтобы сохранить готовый PDF-файл на ваше устройство. Вся обработка выполняется локально в вашем браузере без отправки данных на сервер."
  faq_title: "Вопросы и ответы"
  faq_1_q: "Можно ли объединить несколько PDF-файлов в один?"
  faq_1_a: "Да. Просто загрузите PDF-файлы по очереди (или все сразу). Страницы всех файлов отобразятся вместе, и вы сможете переупорядочить их перед скачиванием."
  faq_2_q: "Можно ли удалить только определенные страницы?"
  faq_2_a: "Да. Наведите курсор на любую миниатюру страницы и нажмите на иконку удаления. Страница будет помечена как удаленная и не попадет в итоговый PDF-файл."
  faq_3_q: "Поддерживает ли редактор PDF-файлы, защищенные паролем?"
  faq_3_a: "Нет. Защищенные паролем PDF-файлы не могут быть открыты в редакторе. Пожалуйста, снимите пароль с файла перед его редактированием."
