...
{
  en: {
    pageTitle: "UUID / GUID Generator - Random UUID v4 Online | Free",
    title: "UUID Generator",
    meta: "Free online UUID v4 / GUID generator. Create single or multiple random unique identifiers instantly for software, databases, APIs and distributed systems. RFC 4122 compliant.",
    d1: "Generate universally unique identifiers (UUID/GUID) with one click. UUID v4 — also known as GUID (Globally Unique Identifier) — is a 36-character alphanumeric code specified by RFC 4122. Generate a single random UUID or a uuid4 bulk list for testing, database seeding, and distributed systems.",
    ...
    faq_5_q: "What is the difference between UUID and GUID?",
    faq_5_a: "UUID and GUID refer to the same standard. GUID (Globally Unique Identifier) is Microsoft's name for UUID. Both follow RFC 4122 and are interchangeable in most contexts.",
  ...
  pt: {
    pageTitle: "Gerador de UUID / GUID - UUID v4 Aleatório Online | Grátis",
    title: "Gerador de UUID",
    meta: "Gerador de UUID v4 / GUID online grátis. Crie identificadores únicos aleatórios instantaneamente para software, bancos de dados, APIs e sistemas distribuídos. Compatível com RFC 4122.",
    d1: "Gere identificadores universalmente únicos (UUID/GUID) com um clique. UUID v4 — também conhecido como GUID (Globally Unique Identifier) — é um código alfanumérico de 36 caracteres especificado pela RFC 4122. Gere um UUID aleatório ou uma lista em lote de uuid4 para testes, população de bancos de dados e sistemas distribuídos.",
    ...
    faq_5_q: "Qual é a diferença entre UUID e GUID?",
    faq_5_a: "UUID e GUID se referem ao mesmo padrão. GUID (Globally Unique Identifier) é o nome utilizado pela Microsoft para UUID. Ambos seguem a RFC 4122 e são intercambiáveis na maioria dos contextos.",
  ...
  es: {
    pageTitle: "Generador de UUID / GUID - UUID v4 Aleatorio Online | Gratis",
    title: "Generador de UUID",
    meta: "Generador de UUID v4 / GUID online gratis. Crea identificadores únicos aleatorios al instante para software, bases de datos, APIs y sistemas distribuidos. Compatible con RFC 4122.",
    d1: "Genera identificadores universalmente únicos (UUID/GUID) con un clic. UUID v4 — también conocido como GUID (Globally Unique Identifier) — es un código alfanumérico de 36 caracteres especificado por RFC 4122. Genera un UUID aleatorio o una lista en lote de uuid4 para pruebas, llenado de bases de datos y sistemas distribuidos.",
    features_title: "Funcionalidades",
    ...
    faq_5_q: "¿Cuál es la diferencia entre UUID y GUID?",
    faq_5_a: "UUID y GUID hacen referencia al mismo estándar. GUID (Globally Unique Identifier) es el nombre de Microsoft para UUID. Ambos siguen RFC 4122 y son intercambiables en la mayoría de los contextos.",
  ...
  fr: {
    pageTitle: "Générateur UUID / GUID - UUID v4 Aléatoire en Ligne | Gratuit",
    title: "Générateur de UUID",
    meta: "Générateur de UUID v4 / GUID en ligne gratuit. Créez des identifiants uniques aléatoires instantanément pour logiciels, bases de données, APIs et systèmes distribués. Conforme RFC 4122.",
    d1: "Générez des identifiants universellement uniques (UUID/GUID) en un clic. UUID v4 — aussi connu sous le nom GUID (Globally Unique Identifier) — est un code alphanumérique de 36 caractères spécifié par la RFC 4122. Générez un UUID aléatoire ou une liste en lot de uuid4 pour les tests, le remplissage de bases de données et les systèmes distribués.",
    ...
    faq_5_q: "Quelle est la différence entre UUID et GUID ?",
    faq_5_a: "UUID et GUID font référence au même standard. GUID (Globally Unique Identifier) est le nom Microsoft pour UUID. Les deux suivent la RFC 4122 et sont interchangeables dans la plupart des contextes.",
  ...
  it: {
    pageTitle: "Generatore UUID / GUID - UUID v4 Casuale Online | Gratis",
    title: "Generatore di UUID",
    meta: "Generatore di UUID v4 / GUID online gratis. Crea identificatori unici casuali istantaneamente per software, database, API e sistemi distribuiti. Conforme RFC 4122.",
    d1: "Genera identificatori universalmente unici (UUID/GUID) con un clic. UUID v4 — noto anche come GUID (Globally Unique Identifier) — è un codice alfanumerico di 36 caratteri specificato dalla RFC 4122. Genera un UUID casuale o una lista in blocco di uuid4 per test, popolamento di database e sistemi distribuiti.",
    ...
    faq_5_q: "Qual è la differenza tra UUID e GUID?",
    faq_5_a: "UUID e GUID si riferiscono allo stesso standard. GUID (Globally Unique Identifier) è il nome Microsoft per UUID. Entrambi seguono RFC 4122 e sono intercambiabili nella maggior parte dei contesti.",
  ...
  id: {
    pageTitle: "Generator UUID / GUID - UUID v4 Acak Online | Gratis",
    title: "Generator UUID",
    meta: "Generator UUID v4 / GUID online gratis. Buat identifier unik acak secara instan untuk software, database, API, dan sistem terdistribusi. Sesuai RFC 4122.",
    d1: "Hasilkan identifier unik secara universal (UUID/GUID) dengan satu klik. UUID v4 — juga dikenal sebagai GUID (Globally Unique Identifier) — adalah kode alfanumerik 36 karakter yang ditentukan oleh RFC 4122. Hasilkan satu UUID acak atau daftar uuid4 dalam jumlah banyak untuk pengujian, pengisian database, dan sistem terdistribusi.",
    ...
    faq_5_q: "Apa perbedaan antara UUID dan GUID?",
    faq_5_a: "UUID dan GUID merujuk pada standar yang sama. GUID (Globally Unique Identifier) adalah nama Microsoft untuk UUID. Keduanya mengikuti RFC 4122 dan dapat dipertukarkan di sebagian besar konteks.",
  ...
  de: {
    pageTitle: "UUID / GUID-Generator – Zufällige UUID v4 Online | Kostenlos",
    title: "UUID-Generator",
    meta: "Kostenloser online UUID v4 / GUID Generator. Erstelle sofort einzelne oder mehrere zufällige eindeutige Identifikatoren für Software, Datenbanken, APIs und verteilte Systeme. RFC 4122 konform.",
    d1: "Erzeuge universell eindeutige Identifikatoren (UUID/GUID) mit einem Klick. UUID v4 — auch bekannt als GUID (Globally Unique Identifier) — ist ein 36-stelliger alphanumerischer Code gemäß RFC 4122. Generiere eine zufällige UUID oder eine uuid4-Liste für Tests, Datenbank-Seeding und verteilte Systeme.",
    ...
    faq_5_q: "Was ist der Unterschied zwischen UUID und GUID?",
    faq_5_a: "UUID und GUID beziehen sich auf denselben Standard. GUID (Globally Unique Identifier) ist Microsofts Name für UUID. Beide folgen RFC 4122 und sind in den meisten Kontexten austauschbar.",
  ...
  nl: {
    pageTitle: "UUID / GUID-generator - Willekeurige UUID v4 Online | Gratis",
    title: "UUID-generator",
    meta: "Gratis online UUID v4 / GUID-generator. Maak direct enkele of meerdere willekeurige unieke identificatiecodes voor software, databases, API's en gedistribueerde systemen. RFC 4122-conform.",
    d1: "Genereer universeel unieke identificatiecodes (UUID/GUID) met één klik. UUID v4 — ook bekend als GUID (Globally Unique Identifier) — is een alfanumerieke code van 36 tekens gespecificeerd door RFC 4122. Genereer een enkele willekeurige UUID of een bulklijst van uuid4 voor testen, database-seeding en gedistribueerde systemen.",
    ...
    faq_5_q: "Wat is het verschil tussen UUID en GUID?",
    faq_5_a: "UUID en GUID verwijzen naar dezelfde standaard. GUID (Globally Unique Identifier) is Microsofts naam voor UUID. Beide volgen RFC 4122 en zijn in de meeste contexten uitwisselbaar.",
  ...
  ru: {
    pageTitle: "Генератор UUID / GUID — случайные UUID v4 онлайн | Бесплатно",
    title: "Генератор UUID",
    meta: "Бесплатный онлайн-генератор UUID v4 / GUID. Мгновенно создавайте один или несколько случайных уникальных идентификаторов для программ, баз данных, API и распределенных систем. Соответствует стандарту RFC 4122.",
    d1: "Генерируйте универсально уникальные идентификаторы (UUID/GUID) в один клик. UUID v4 — также известный как GUID (Globally Unique Identifier) — представляет собой 36-символьный буквенно-цифровой код, определенный стандартом RFC 4122. Генерируйте один случайный UUID или создавайте списки UUID v4 для тестирования, заполнения баз данных и распределенных систем.",
    features_title: "Возможности",
    f_1: "Мгновенная генерация UUID v4 в браузере",
    f_2: "Генерация списков до 100 UUID за один раз",
    f_3: "Копирование отдельных значений или всего списка в один клик",
    f_4: "Формат UUID v4, полностью соответствующий RFC 4122",
    how_title: "Как работает генератор UUID",
    how_desc: "Нажмите кнопку генерации, чтобы мгновенно создать случайный UUID v4 в вашем браузере. Если вам нужен список, активируйте режим генерации нескольких номеров и укажите их количество (от 2 до 100). Каждый UUID создается по стандартному шаблону версии 4, определенному в RFC 4122, что делает инструмент незаменимым для тестирования, разработки, интеграции и моделирования данных.",
    use_cases_title: "Основные варианты использования",
    use_1_t: "Разработка программного обеспечения",
    use_1_d: "Создавайте уникальные идентификаторы для объектов, записей и внутренних ссылок в архитектуре вашего приложения.",
    use_2_t: "Первичные ключи баз данных",
    use_2_d: "Генерируйте распределенные первичные ключи без использования автоинкрементных последовательностей, что идеально для распределенных систем.",
    use_3_t: "API и микросервисы",
    use_3_d: "Назначайте уникальные идентификаторы ресурсов, идентификаторы запросов (Request ID) и корреляции для отслеживания транзакций между сервисами.",
    use_4_t: "Тестирование и наполнение баз данных",
    use_4_d: "Создавайте списки реалистичных уникальных значений для тестирования (QA), тестовых баз данных (fixtures) и автоматических тестов.",
    use_5_t: "Отслеживание и логирование",
    use_5_d: "Безопасно маркируйте задачи, события, пользовательские сессии и импортируемые данные для обеспечения их уникальности и отслеживаемости.",
    how_to_use_title: "Как использовать этот инструмент",
    step_1_title: "Выберите режим работы",
    step_1_desc: "Выберите генерацию одного UUID для быстрого результата или активируйте опцию «Генерировать несколько UUID», чтобы задать количество (от 2 до 100).",
    step_2_title: "Генерация",
    step_2_desc: "Нажмите кнопку генерации. Сгенерированные UUID мгновенно отобразятся на экране и будут готовы к использованию.",
    step_3_title: "Копирование",
    step_3_desc: "Нажмите на иконку копирования рядом с любым UUID или используйте кнопку «Копировать все» для копирования всего списка за один раз.",
    faq_title: "Вопросы и ответы",
    faq_1_q: "Что такое UUID?",
    faq_1_a: "UUID (Universally Unique Identifier) — это стандарт универсального уникального идентификатора длиной 128 бит, определенный RFC 4122. Версия 4 использует случайные числа для создания уникальных кодов, что делает вероятность коллизий практически нулевой.",
    faq_2_q: "Действительно ли UUID v4 уникальны?",
    faq_2_a: "Да. При использовании 122 случайных бит существует 5,3 ундециллиона возможных комбинаций. Вероятность совпадения двух случайно сгенерированных UUID астрономически мала, что делает их абсолютно надежными для распределенных систем.",
    faq_3_q: "В чем разница между версиями UUID?",
    faq_3_a: "Версия 1 использует метку времени и MAC-адрес устройства; версия 4 основывается исключительно на случайных числах (самая распространенная); версия 5 генерирует идентификаторы на основе хэша SHA-1 и пространства имен. Версия 4 предпочтительнее за счет простоты и конфиденциальности (не раскрывает аппаратную информацию устройства).",
    faq_4_q: "Могу ли я использовать UUID в качестве первичных ключей в базах данных?",
    faq_4_a: "Да. UUID идеально подходят для распределенных баз данных, где автоинкрементные ID привели бы к конфликтам при слиянии данных. Они позволяют безопасно генерировать ID на стороне клиента без согласования с БД.",
    faq_5_q: "В чем разница между UUID и GUID?",
    faq_5_a: "UUID и GUID относятся к одному и тому же стандарту. GUID (Globally Unique Identifier) — это терминология корпорации Microsoft для UUID. Оба формата соответствуют стандарту RFC 4122 и взаимозаменяемы в большинстве контекстов.",
    multiple_label: "Генерировать несколько UUID",
    quantity: "Количество",
    bt: "Сгенерировать UUID",
    bt_multiple: "Сгенерировать UUID",
    generated_uuids: "Сгенерированные UUID ({count})",
    copy_all: "Копировать все",
    copied: "Скопировано!",
    placeholder: "Нажмите «Сгенерировать», чтобы создать UUID",
    see1: "Генератор Crontab",
    see2: "Генератор случайных чисел",
