...
<i18n lang="yaml">
{
  ...
  ru: {
    title: "Генератор хэшей MD5",
    meta: "Легко рассчитывайте хэш MD5 (128-битный цифровой отпечаток) для любого текста и проверяйте целостность данных путем сравнения хэшей.",
    desc: "MD5 (Message Digest Algorithm 5) — широко используемый криптографический алгоритм хэширования, который создает 128-битный (32-символьный) отпечаток для любого исходного текста или данных. В основном он применяется для проверки целостности данных, так как генерирует уникальный и постоянный хэш независимо от размера исходных данных. Любое, даже самое незначительное изменение на входе полностью меняет этот код, позволяя легко выявить любые модификации. MD5 часто используется для проверки того, что файлы не были изменены, однако для высокозащищенного хэширования паролей рекомендуется использовать более современные алгоритмы, такие как SHA-256 или Bcrypt.",
    bt: "Рассчитать",
    ...
    see4: "XML → JSON",
    tip_title: "Предупреждение о безопасности",
    tip_security: "MD5 небезопасен для хэширования паролей, так как он уязвим к атакам поиска коллизий.",
    tip_usage: "Мы рекомендуем использовать Bcrypt для безопасности. MD5 лучше всего подходит для проверки целостности файлов (контрольной суммы/Checksum).",
    result: "Результат",
    how_to_use_title: "Как использовать",
    step_1_title: "Введите текст",
    step_1_desc: "Введите или вставьте исходный текст в поле ввода.",
    step_2_title: "Сгенерируйте хэш",
    step_2_desc: "Нажмите кнопку «Рассчитать хэш MD5» для обработки текста.",
    step_3_title: "Скопируйте результат",
    step_3_desc: "Уникальный 32-символьный хэш MD5 будет мгновенно сгенерирован для копирования.",
    f_1: "Быстрый расчет хэшей MD5",
    f_2: "128-битный цифровой отпечаток",
    f_3: "Проверка целостности данных",
