...
<i18n lang="yaml">
{
  en: {
    ...
    d2: "Converting CSV to JSON is especially useful when integrating tabular data into web applications, migrating legacy database exports, or consuming REST APIs that expect JSON payloads. Paste your CSV, choose the delimiter if needed, and click Convert to get the result instantly.",
    bt: "Convert",
    rst: "Start Over",
    copy: "Copy",
  ...
  pt: {
    ...
    d2: "Converter CSV para JSON é especialmente útil ao integrar dados tabulares em sistemas web, migrar exportações de bancos de dados legados ou consumir APIs REST que esperam payloads em JSON. Basta colar o CSV, escolher o separador e clicar em Converter para obter o resultado instantaneamente.",
    bt: "Converter",
    rst: "Recomeçar",
    copy: "Copiar",
  ...
  es: {
    ...
    d2: "Convertir CSV a JSON es especialmente útil al integrar datos tabulares en aplicaciones web, migrar exportaciones de bases de datos heredadas o consumir APIs REST que esperan payloads en JSON. Pega tu CSV, elige el separador si es necesario y haz clic en Convertir para obtener el resultado al instante.",
    bt: "Convertir",
    rst: "Recomenzar",
    copy: "Copiar",
  ...
  fr: {
    ...
    d2: "Convertir du CSV en JSON est particulièrement utile lors de l'intégration de données tabulaires dans des applications web, de la migration d'exports de bases de données ou de la consommation d'API REST attendant des payloads JSON. Collez votre CSV, choisissez le séparateur si nécessaire et cliquez sur Convertir pour obtenir le résultat instantanément.",
    bt: "Convertir",
    rst: "Recommencer",
    copy: "Copier",
  ...
  it: {
    ...
    d2: "Convertire CSV in JSON è particolarmente utile quando si integrano dati tabulari in applicazioni web, si migrano export di database legacy o si consumano API REST che si aspettano payload JSON. Incolla il tuo CSV, scegli il separatore se necessario e fai clic su Converti per ottenere il risultato all'istante.",
    bt: "Converti",
    rst: "Ricomincia",
    copy: "Copia",
  ...
  id: {
    ...
    d2: "Mengonversi CSV ke JSON sangat berguna saat mengintegrasikan data tabular ke aplikasi web, memindahkan ekspor basis data lama, atau menggunakan REST API yang mengharapkan payload JSON. Tempel CSV Anda, pilih pemisahnya, lalu klik Konversi untuk mendapatkan hasilnya secara instan.",
    bt: "Konversi",
    rst: "Mulai Ulang",
    copy: "Salin",
