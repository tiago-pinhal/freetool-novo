...
<i18n lang="yaml">
{
  ...
  ru: {
    m_title: "Конвертер XML в JSON онлайн — бесплатно и мгновенно",
    title: "Конвертер XML в JSON",
    meta: "Конвертируйте XML в JSON онлайн бесплатно. Вставьте XML и получите чистый отформатированный JSON без необходимости установки каких-либо программ.",
    d1: "Этот инструмент разбирает введенный XML-код и преобразует каждый элемент, атрибут и значение в соответствующий объект JSON. Теги XML становятся ключами объектов, вложенные элементы — вложенными объектами, а повторяющиеся теги автоматически объединяются в массивы, сохраняя исходную иерархию данных.",
    d2: "Конвертация XML в JSON особенно полезна при интеграции систем, работающих только с JSON, миграции устаревших данных или отправке данных в REST API, ожидающие формат JSON.",
    bt: "Конвертировать",
    rst: "Начать заново",
    copy: "Копировать",
    plc: "Вставьте код XML сюда или перетащите файл",
    attr: "Включить атрибуты XML (если есть)",
    err: "Ошибка",
    err_label: "Ошибка парсинга",
    how_it_works_title: "Как это работает",
    hiw_1_title: "Вставьте XML",
    hiw_1_desc: "Вставьте или перетащите файл XML в редактор. Включите опцию атрибутов, если хотите сохранить атрибуты XML-тегов.",
    hiw_2_title: "Нажмите «Конвертировать»",
    hiw_2_desc: "Нажмите «Конвертировать», и инструмент мгновенно преобразует ваш XML в чистый отформатированный JSON.",
    hiw_3_title: "Скопируйте JSON",
    hiw_3_desc: "Готовый JSON появится в редакторе. Нажмите кнопку «Копировать», чтобы скопировать его в буфер обмена.",
    use_cases_title: "Варианты использования",
    uc_1_title: "Интеграция с API",
    uc_1_desc: "Преобразуйте XML-ответы устаревших API в JSON для интеграции с современными фронтенд-приложениями или сервисами.",
    uc_2_title: "Миграция данных",
    uc_2_desc: "Преобразуйте старые наборы данных XML в формат JSON при миграции баз данных или переносе данных между системами.",
    uc_3_title: "Конвертация конфигураций",
    uc_3_desc: "Конвертируйте конфигурационные файлы XML в формат JSON для использования с инструментами и фреймворками, нативно поддерживающими JSON.",
    faq_title: "Вопросы и ответы",
    faq_1_q: "Отправляются ли мои данные XML на сервер?",
    faq_1_a: "Нет. Конвертация выполняется полностью внутри вашего браузера. Ваши данные никогда не покинут ваше устройство.",
    faq_2_q: "Что происходит с атрибутами XML?",
    faq_2_a: "По умолчанию атрибуты игнорируются. Включите опцию «Включить атрибуты XML», чтобы сопоставить их как ключи с префиксом {'@'} в итоговом JSON.",
    faq_3_q: "Что если в моем XML есть повторяющиеся теги?",
    faq_3_a: "Повторяющиеся теги на одном уровне автоматически группируются в массив JSON, что позволяет сохранить исходную структуру.",
    see1: "JSON → XML",
    see2: "CSV → JSON",
    see3: "JSON → CSV",
    see4: "LESS → CSS",
    f_1: "Мгновенная конвертация XML в JSON",
    f_2: "Поддержка атрибутов XML",
    f_3: "Сохранение иерархии и вложенности данных",
