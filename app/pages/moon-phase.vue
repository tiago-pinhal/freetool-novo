...
<i18n lang="yaml">
{
  en: {
    ...
    meta: "Find out the current moon phase: new moon, crescent, full moon or waning. See the illumination percentage and how long until the next phase.",
  ...
  pt: {
    ...
    meta: "Descubra qual é a fase da lua hoje: lua nova, crescente, cheia ou minguante. Veja a porcentagem de iluminação e quanto falta para a próxima fase.",
  ...
  es: {
    ...
    meta: "Descubre la fase lunar actual: luna nueva, creciente, llena o menguante. Ve el porcentaje de iluminación y cuánto falta para la próxima fase.",
  ...
  fr: {
    ...
    meta: "Découvrez la phase lunaire actuelle : nouvelle lune, croissante, pleine lune ou décroissante. Voyez le pourcentage d'illumination et le temps avant la prochaine phase.",
  ...
  it: {
    ...
    meta: "Scopri la fase lunare attuale: luna nuova, crescente, piena o calante. Vedi la percentuale di illuminazione e quanto manca alla prossima fase.",
  ...
  id: {
    pageTitle: "Fase Bulan Hari Ini — Apa Fase Bulan Sekarang? | Gratis",
    title: "Fase Bulan Hari Ini",
    meta: "Temukan fase bulan saat ini: bulan baru, sabit, purnama, atau bulan tua. Lihat persentase pencahayaan dan berapa lama hingga fase berikutnya.",
  ...
  de: {
    ...
    meta: "Finde heraus, in welcher Mondphase wir uns heute befinden: Neumond, zunehmender Mond, Vollmond oder abnehmender Mond. Sieh den Beleuchtungsprozentwert und wie lange bis zur nächsten Phase.",
  ...
  nl: {
    pageTitle: "Maanfase Vandaag — In welke Maanfase bevinden we ons? | Gratis",
    title: "Maanfase Vandaag",
    meta: "Ontdek de huidige maanfase: nieuwe maan, wassende maan, volle maan of afnemende maan. Zie het verlichtingspercentage en hoe lang het duurt tot de volgende fase.",
