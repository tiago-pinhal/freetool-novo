...
<i18n lang="yaml">
{
  ...
  nl: {
    ...
    Pebibyte: "Pebibyte", Pebibit: "Pebibit", Terabyte: "Terabyte", Terabit: "Terabit",
    Tebibyte: "Tebibyte", Tebibit: "Tebibit", Microbyte: "Microbyte", Microbit: "Microbit",
    d1: "Gratis online tool om te converteren tussen 40 opslageenheden — van bits en bytes tot petabytes en pebibits. Ondersteunt zowel SI decimale eenheden (KB = 1.000 bytes) als IEC binaire eenheden (KiB = 1.024 bytes). Ideaal voor ontwikkelaars, systeembeheerders en iedereen die werkt met bestandsgroottes, RAM of netwerkbandbreedte.",
