...
<i18n lang="yaml">
{
  ...
  ru: {
    m_title: "Конвертер JSON в CSV онлайн — бесплатно и мгновенно",
    title: "Конвертер JSON в CSV",
    meta: "Конвертируйте JSON в CSV онлайн бесплатно. Мгновенно преобразуйте массивы объектов JSON в табличный формат CSV, совместимый с Excel.",
    d1: "Этот инструмент преобразует данные в формате JSON в простую таблицу (CSV), упрощая их просмотр и использование в электронных таблицах. Ключи объектов становятся заголовками столбцов, а значения заполняют строки под ними.",
    d2: "Конвертация JSON в CSV крайне полезна для экспорта ответов API в файлы Excel, миграции баз данных в устаревшие системы отчетности или подготовки файлов данных для аналитиков.",
    bt: "Конвертировать",
    rst: "Начать заново",
    copy: "Копировать",
    plc: "Вставьте код JSON сюда или перетащите файл",
    header: "Включить заголовки в первую строку",
    ...
    tab: "Табуляция",
    err: "Ошибка",
    err_label: "Некорректный JSON",
    how_it_works_title: "Как это работает",
    hiw_1_title: "Вставьте JSON",
    hiw_1_desc: "Вставьте или перетащите файл JSON в редактор. Включите опцию заголовков, если хотите, чтобы первая строка CSV содержала имена столбцов.",
    hiw_2_title: "Настройте параметры",
    hiw_2_desc: "Система проверяет синтаксис JSON. Вы можете выбрать, добавлять ли заголовки столбцов в первую строку.",
    hiw_3_title: "Конвертируйте в CSV",
    hiw_3_desc: "Нажмите «Конвертировать», чтобы мгновенно сгенерировать текст CSV с разделением столбцов выбранным разделителем.",
    use_cases_title: "Варианты использования",
    uc_1_title: "Экспорт в электронные таблицы",
    uc_1_desc: "Преобразование структурированных данных JSON (например, ответов API) в читаемый формат для Excel или Google Таблиц.",
    uc_2_title: "Миграция систем",
    uc_2_desc: "Конвертация документоориентированных данных для простого импорта в традиционные реляционные базы данных.",
    faq_title: "Вопросы и ответы",
    faq_1_q: "Сохраняются ли мои данные JSON на сервере?",
    faq_1_a: "Нет. Вся обработка происходит исключительно в вашем браузере. Мы никогда не передаем и не храним ваши данные JSON на наших серверах.",
    faq_2_q: "Какая структура JSON поддерживается?",
    faq_2_a: "Инструмент ожидает массив объектов JSON, где каждый объект представляет собой строку, а его ключи становятся заголовками столбцов CSV.",
    faq_3_q: "Могу ли я использовать разделитель, отличный от запятой?",
    faq_3_a: "Да. Вы можете выбирать между запятыми, точками с запятой, вертикальной чертой или табуляцией в соответствии с форматом, который ожидает ваше программное обеспечение.",
    see1: "CSV → JSON",
    see2: "XML → JSON",
    see3: "JSON → XML",
    see4: "JSON Viewer",
    f_1: "Мгновенная конвертация JSON в CSV",
    f_2: "Поддержка пользовательских разделителей",
    f_3: "Автоматическое выравнивание объектов",
