...
<i18n lang="yaml">
{
  en: {
    ...
    label_s: "Seconds",
    result_label: "Result",
    how_desc: "Pick a reference date, enter the interval you want to subtract, and the result appears instantly. Switch to Date & Time mode to also subtract hours, minutes and seconds. Useful for finding warranty start dates, retroactive planning, historical research and more.",
    ...
    use_1_t: "Warranty & Guarantees",
    use_1_d: "Find the purchase date or start of a warranty period by subtracting its duration from the expiry date.",
    use_2_t: "Retroactive Planning",
    use_2_d: "Work backwards from a deadline to find the latest possible start date for a project or task.",
    use_3_t: "Historical Research",
    use_3_d: "Calculate dates of past events by subtracting known intervals from a reference point.",
  ...
  pt: {
    ...
    how_desc: "Escolha uma data de referência, informe o intervalo que deseja subtrair e o resultado aparece instantaneamente. Use o modo Data e Hora para também subtrair horas, minutos e segundos. Útil para encontrar datas de início de garantia, planejamento retroativo, pesquisa histórica e muito mais.",
    ...
    use_1_d: "Encontre a data de compra ou início de uma garantia subtraindo sua duração da data de vencimento.",
    use_2_t: "Planejamento Retroativo",
    use_2_d: "Trabalhe de trás para frente a partir de um prazo final para encontrar a data de início mais tarde possível.",
    use_3_t: "Pesquisa Histórica",
    use_3_d: "Calcule datas de eventos passados subtraindo intervalos conhecidos de um ponto de referência.",
  ...
  es: {
    ...
    label_s: "Segundos",
    result_label: "Resultado",
    how_desc: "Elige una fecha de referencia, introduce el intervalo que quieres restar y el resultado aparece al instante. Activa el modo Fecha y Hora para también restar horas, minutos y segundos. Ideal para encontrar fechas de inicio de garantía, planificación retroactiva, investigación histórica y más.",
    ...
    use_1_d: "Encuentra la fecha de compra o inicio de una garantía restando su duración de la fecha de vencimiento.",
    use_2_t: "Planificación Retroactiva",
    use_2_d: "Trabaja hacia atrás desde una fecha límite para encontrar la fecha de inicio más tardía posible.",
    use_3_t: "Investigación Histórica",
    use_3_d: "Calcula fechas de eventos pasados restando intervalos conocidos desde un punto de referencia.",
  ...
  fr: {
    ...
    how_desc: "Choisissez une date de référence, saisissez l'intervalle à soustraire et le résultat apparaît instantanément. Activez le mode Date et Heure pour aussi soustraire heures, minutes et secondes. Idéal pour retrouver des dates de début de garantie, la planification rétroactive, la recherche historique et plus encore.",
    ...
    use_1_d: "Retrouvez la date d'achat ou le début d'une garantie en soustrayant sa durée de la date d'expiration.",
    use_2_t: "Planification Rétroactive",
    use_2_d: "Travaillez à rebours depuis une échéance pour trouver la date de début la plus tardive possible.",
    use_3_t: "Recherche Historique",
    use_3_d: "Calculez des dates d'événements passés en soustrayant des intervalles connus d'un point de référence.",
  ...
  it: {
    ...
    how_desc: "Scegli una data di riferimento, inserisci l'intervallo da sottrarre e il risultato appare istantaneamente. Attiva la modalità Data e Ora per sottrarre anche ore, minuti e secondi. Ideale per trovare date di inizio garanzia, pianificazione retroattiva, ricerca storica e molto altro.",
    ...
    use_1_d: "Trova la data di acquisto o l'inizio di una garanzia sottraendo la sua durata dalla data di scadenza.",
    use_2_t: "Pianificazione Retroattiva",
    use_2_d: "Lavora a ritroso da una scadenza per trovare la data di inizio più tardi possibile.",
    use_3_t: "Ricerca Storica",
    use_3_d: "Calcola date di eventi passati sottraendo intervalli noti da un punto di riferimento.",
  ...
  id: {
    ...
    label_s: "Detik",
    result_label: "Hasil",
    how_desc: "Pilih tanggal referensi, masukkan interval yang ingin dikurangi, dan hasilnya langsung muncul. Aktifkan mode Tanggal & Waktu untuk juga mengurangi jam, menit, dan detik. Berguna untuk menemukan tanggal mulai garansi, perencanaan retroaktif, penelitian sejarah, dan banyak lagi.",
