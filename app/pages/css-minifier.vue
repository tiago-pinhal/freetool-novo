...
<i18n lang="yaml">
{
  ...
  de: {
    ...
    hiw_1_desc: "Kopiere und füge deinen CSS-Quellcode in den Editor ein.",
    hiw_2_title: "Minifizieren klicken",
    hiw_2_desc: "Klicke auf „CSS minifizieren“ und der Code wird sofort komprimiert.",
    ...
    uc_1_desc: "Reduziere die Größe von Stylesheets vor dem Deployment für schnellere Ladezeiten und geringeren Bandbreitenverbrauch.",
    uc_2_title: "E-Mail-Templates",
    uc_2_desc: "Minifiziere Inline-CSS in E-Mail-Vorlagen, um die Nachrichtengröße klein zu halten und die Zustellbarkeit zu verbessern.",
    uc_3_title: "Lighthouse & Core Web Vitals",
    uc_3_desc: "Kleinere CSS-Payloads reduzieren direkt die renderblockierende Zeit und verbessern die First Contentful Paint-Werte.",
    faq_title: "Fragen & Antworten",
    faq_1_q: "Wird mein CSS-Code an einen Server gesendet?",
    faq_1_a: "Nein. Die gesamte Verarbeitung erfolgt in deinem Browser. Dein Code verlässt dein Gerät nicht.",
    faq_2_q: "Beschädigt die Minifizierung mein CSS?",
    faq_2_a: "Nein. Es werden nur Leerzeichen und Kommentare entfernt, die keinen Einfluss auf das Rendering haben. Das Ergebnis ist funktional identisch mit dem Original.",
    faq_3_q: "Was passiert, wenn mein CSS Syntaxfehler enthält?",
    faq_3_a: "Wenn das CSS nicht geparst werden kann, zeigt das Tool eine Fehlermeldung an, damit du das Problem identifizieren und beheben kannst.",
    see1: "HTML-Minifier",
    see2: "JavaScript-Minifier",
    see3: "CSS-Formatter",
    see4: "JavaScript-Formatter",
    f_1: "Sofortige CSS-Kompression und -Minifizierung",
    f_2: "Entfernt Leerzeichen, Kommentare und redundante Regeln",
    f_3: "Unterstützt reines CSS und style-Tag-Blöcke",
  ...
  nl: {
    ...
    copy: "Kopiëren",
    err: "Fout",
    err_label: "CSS kon niet worden geminificeerd",
    ...
    hiw_2_desc: "Klik op de knop CSS minifiëren en de code wordt direct gecomprimeerd.",
    ...
    uc_1_desc: "Verklein stylesheets vóór deployment voor snellere laadtijden en minder bandbreedtegebruik.",
    uc_2_title: "E-mailtemplates",
    uc_2_desc: "Minifieer inline CSS in e-mailtemplates om berichten klein te houden en de afleverbaarheid te verbeteren.",
    uc_3_title: "Lighthouse & Core Web Vitals",
    ...
    faq_1_a: "Nee. Alle verwerking gebeurt volledig in je browser. Je code verlaat je apparaat niet.",
    faq_2_q: "Breekt minificatie mijn CSS?",
    faq_2_a: "Nee. De tool verwijdert alleen spaties en opmerkingen die geen effect hebben op de weergave. Het resultaat is functioneel identiek aan het origineel.",
    faq_3_q: "Wat gebeurt er als mijn CSS syntaxisfouten bevat?",
    faq_3_a: "Als de CSS niet kan worden geparseerd, toont de tool een foutmelding zodat je het probleem kunt identificeren en oplossen.",
    see1: "HTML-minifier",
    see2: "JavaScript-minifier",
    see3: "CSS-formatter",
    see4: "JavaScript-formatter",
