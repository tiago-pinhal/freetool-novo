...
<i18n lang="yaml">
{
  ...
  de: {
    ...
    bt: "HTML minifizieren",
    rst: "Zurücksetzen",
    copy: "Kopieren",
    err: "Fehler",
    err_label: "HTML konnte nicht minifiziert werden",
    how_it_works_title: "So funktioniert es",
    hiw_1_title: "HTML einfügen",
    hiw_1_desc: "Kopiere und füge deinen HTML-Quellcode in den Editor ein.",
    hiw_2_title: "Minifizieren klicken",
    hiw_2_desc: "Klicke auf „HTML minifizieren“ und der Code wird sofort komprimiert.",
    ...
    uc_1_desc: "Reduziere die HTML-Dateigröße vor dem Deployment für schnellere Ladezeiten und geringeren Bandbreitenverbrauch.",
    uc_2_title: "Template-Optimierung",
    uc_2_desc: "Minifiziere HTML-Templates in Web-Apps oder E-Mail-Kampagnen für bessere Performance und Zustellbarkeit.",
    uc_3_title: "Lighthouse & Core Web Vitals",
    uc_3_desc: "Kleinere HTML-Payloads verbessern direkt Time to First Byte und First Contentful Paint.",
    ...
    faq_2_q: "Beschädigt die Minifizierung mein HTML?",
    faq_2_a: "Nein. Es werden nur Leerzeichen, Kommentare und redundante Attribute entfernt, die keinen Einfluss auf das Rendering haben. Das Ergebnis ist funktional identisch mit dem Original.",
    faq_3_q: "Was passiert, wenn mein HTML Syntaxfehler enthält?",
    faq_3_a: "Wenn das HTML nicht geparst werden kann, zeigt das Tool eine Fehlermeldung an, damit du das Problem identifizieren und beheben kannst.",
    see1: "CSS-Minifier",
    see2: "JavaScript-Minifier",
    see3: "HTML-Formatter",
    see4: "JavaScript-Formatter",
    f_1: "Sofortige HTML-Kompression und -Minifizierung",
    f_2: "Entfernt Leerzeichen, Kommentare und redundante Attribute",
    f_3: "Minifizierung von Inline-CSS und JavaScript",
  ...
  nl: {
    ...
    copy: "Kopiëren",
    err: "Fout",
    err_label: "HTML kon niet worden geminificeerd",
    how_it_works_title: "Hoe het werkt",
    hiw_1_title: "Plak je HTML",
    hiw_1_desc: "Kopieer en plak je HTML-broncode in de editor.",
    hiw_2_title: "Klik op minifiëren",
    hiw_2_desc: "Klik op de knop HTML minifiëren en de code wordt direct gecomprimeerd.",
    ...
    uc_1_desc: "Verklein HTML-bestanden vóór deployment voor snellere laadtijden en minder bandbreedtegebruik.",
    uc_2_title: "Template-optimalisatie",
    uc_2_desc: "Minifieer HTML-templates in webapps of e-mailcampagnes om prestaties en afleverbaarheid te verbeteren.",
    uc_3_title: "Lighthouse & Core Web Vitals",
    uc_3_desc: "Kleinere HTML-payloads verbeteren direct Time to First Byte en First Contentful Paint.",
    ...
    faq_2_q: "Breekt minificatie mijn HTML?",
    faq_2_a: "Nee. De tool verwijdert alleen spaties, opmerkingen en overbodige attributen die geen invloed hebben op de weergave. Het resultaat is functioneel identiek aan het origineel.",
    faq_3_q: "Wat gebeurt er als mijn HTML syntaxisfouten bevat?",
    faq_3_a: "Als de HTML niet kan worden geparseerd, toont de tool een foutmelding zodat je het probleem kunt identificeren en oplossen.",
    see1: "CSS-minifier",
    see2: "JavaScript-minifier",
    see3: "HTML-formatter",
    see4: "JavaScript-formatter",
    f_1: "Directe HTML-compressie en minificatie",
