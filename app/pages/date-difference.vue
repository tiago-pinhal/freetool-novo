...
<i18n lang="yaml">
{
  en: {
    ...
    pageTitle: "Days Between Two Dates — Date Difference Calculator | Free",
    meta: "Calculate the days between two dates instantly. Get the exact difference in years, months and days, plus equivalents in weeks, hours and minutes.",
    param1: "Start Date",
    param2: "End Date",
  ...
  pt: {
    ...
    pageTitle: "Calcular Dias Entre Duas Datas — Calculadora de Diferença | Grátis",
    meta: "Conte e calcule os dias entre duas datas com precisão. Obtenha o resultado exato em anos, meses e dias, mais equivalentes em semanas, horas e minutos.",
    param1: "Data Inicial",
    param2: "Data Final",
  ...
  es: {
    ...
    pageTitle: "Calcular Días Entre Fechas — Calculadora de Diferencia de Fechas | Gratis",
    meta: "Cuenta y calcula los días entre dos fechas al instante. Obtén el resultado exacto en años, meses y días, además de equivalentes en semanas, horas y minutos.",
  ...
  fr: {
    ...
    pageTitle: "Calculer les Jours entre Deux Dates — Différence entre Deux Dates | Gratuit",
    meta: "Calculez les jours entre deux dates instantanément. Obtenez le résultat exact en années, mois et jours, ainsi que les équivalents en semaines, heures et minutes.",
  ...
  it: {
    ...
    pageTitle: "Calcolo Giorni tra Due Date — Calcolatore di Differenza | Gratis",
    meta: "Calcola i giorni tra due date all'istante. Ottieni il risultato esatto in anni, mesi e giorni, più gli equivalenti in settimane, ore e minuti.",
  ...
  id: {
    ...
    pageTitle: "Hitung Selisih Hari Antara Dua Tanggal — Kalkulator Selisih Tanggal",
    meta: "Hitung selisih hari antara dua tanggal secara instan. Dapatkan hasil tepat dalam tahun, bulan, dan hari, plus setara dalam minggu, jam, dan menit.",
  ...
  de: {
    ...
    pageTitle: "Tage zwischen zwei Daten berechnen — Datumsdifferenz-Rechner | Gratis",
    meta: "Berechnen Sie die Tage zwischen zwei Daten sofort. Erhalten Sie das exakte Ergebnis in Jahren, Monaten und Tagen sowie Entsprechungen in Wochen, Stunden und Minuten.",
    param1: "Startdatum",
    param2: "Enddatum",
  ...
  nl: {
    ...
    pageTitle: "Aantal dagen tussen twee datums — Datumsverschil berekenen | Gratis",
    meta: "Bereken het aantal dagen tussen twee datums. Krijg exacte resultaten in jaren, maanden en dagen, plus equivalenten in weken, uren en minuten.",
    param1: "Begindatum",
    param2: "Einddatum",
    diff: "Exact verschil",
    or: "Of gelijkwaardig…",
  ...
  ru: {
    ...
    pageTitle: "Расчет дней между двумя датами — калькулятор разницы дат | Бесплатно",
    meta: "Точно рассчитайте количество дней между двумя датами. Получите точную разницу в годах, месяцах и днях, а также эквиваленты в неделях, часах и минутах.",
    param1: "Начальная дата",
    param2: "Конечная дата",
    diff: "Точная разница",
    or: "Или эквивалентно…",
    years_label: "Лет",
    ...
    eq: "Пожалуйста, выберите две разные даты, чтобы рассчитать разницу между ними",
    features_title: "Возможности",
    f_1: "Точный расчет разницы в годах, месяцах и оставшихся днях",
    f_2: "Эквивалентные итоги в месяцах, неделях, днях, часах и минутах",
    f_3: "Автоматический учет високосных лет",
    f_4: "Автоматическое исправление хронологического порядка дат",
    how_desc: "Узнайте точно, сколько времени разделяет любые две даты. Результат показывает разницу с разбивкой по годам, месяцам и дням, а также удобные эквиваленты в неделях, общем количестве дней, часах или минутах. Учет високосных лет и разной продолжительности месяцев происходит автоматически.",
    use_cases_title: "Основные области применения",
    use_1_t: "Управление проектами",
    use_1_d: "Отслеживайте дедлайны, этапы и графики выполнения ваших проектов и профессиональных целей.",
    use_2_t: "Планирование мероприятий",
    use_2_d: "Планируйте мероприятия на основе конкретных дат и точных интервалов для безупречной координации.",
    use_3_t: "Контроль сроков",
    use_3_d: "Поддерживайте порядок, точно рассчитывая сроки выполнения задач, даты встреч или визитов.",
    use_4_t: "Финансовые расчеты",
    use_4_d: "Определяйте периоды выплат, сроки действия договоров и продолжительность инвестиций для лучшего финансового контроля.",
    use_5_t: "Личное планирование",
    use_5_d: "Планируйте поездки, юбилеи и другие личные дела, не пытаясь угадать точную продолжительность.",
    use_6_t: "Обучение и учеба",
    use_6_d: "Рассчитывайте сроки сдачи учебных работ, учебные семестры и расписание занятий, чтобы оптимизировать время обучения.",
    use_7_t: "Здоровье и благополучие",
    use_7_d: "Точно отслеживайте интервалы между визитами к врачу, курсами лечения или циклами приема лекарств.",
    how_to_use_title: "Как пользоваться этим инструментом",
    step_1_title: "Укажите начальную дату",
    step_1_desc: "Нажмите на поле начальной даты и выберите первую дату в календаре или введите ее вручную.",
    step_2_title: "Укажите конечную дату",
    step_2_desc: "Нажмите на поле конечной даты и выберите вторую дату. Результаты отобразятся мгновенно.",
    step_3_title: "Ознакомьтесь с результатами",
    step_3_desc: "В первой строке отображается точная разница в годах, месяцах и днях. Во второй строке показаны удобные эквивалентные итоги.",
    ex_title: "Популярные примеры использования",
    ex1: "Планирование отпуска: с 20 декабря по 5 января — калькулятор показывает 16 дней, что позволяет легко рассчитать отгулы или забронировать жилье.",
    ex2: "Срок сдачи проекта: с 1 марта по 30 июня — результат составляет 3 месяца и 29 дней, что очень полезно для планирования спринтов и ключевых этапов.",
    ex3: "Отслеживание беременности: с 14 февраля по 14 ноября — ровно 9 месяцев, что помогает будущим родителям заранее спланировать все дела.",
    ex4: "Срок действия договора: с 1 января по 31 декабря — 365 дней (или 366 дней в високосном году), стандартный период для годовых соглашений.",
    faq_title: "Вопросы и ответы",
    faq1q: "Включает ли калькулятор начальную дату в расчет?",
    faq1a: "Нет. Калькулятор рассчитывает время, прошедшее между двумя датами. Например, период с 1 по 3 января составит 2 дня — первый день не включается в подсчет.",
    faq2q: "Правильно ли инструмент обрабатывает високосные года?",
    faq2a: "Да. Расчет учитывает високосные года. Например, в феврале 2024 года было 29 дней, и это автоматически отражается на результатах.",
    faq3q: "Что произойдет, если конечная дата будет раньше начальной?",
    faq3a: "Инструмент автоматически поменяет даты местами и рассчитает разницу в обычном режиме. Вы всегда получите положительный результат, независимо от порядка ввода.",
    see1: "Калькулятор разницы во времени",
    see2: "Калькулятор разницы дат и времени",
