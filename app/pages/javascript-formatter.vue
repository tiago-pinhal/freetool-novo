...
<i18n lang="yaml">
{
  ...
  ru: {
    m_title: "Форматтер JavaScript онлайн — форматируйте и индентируйте JS бесплатно",
    title: "Форматтер JavaScript",
    meta: "Бесплатный онлайн-форматтер и структуризатор JavaScript. Вставьте свой JS-код, чтобы мгновенно отформатировать, индентировать и выровнять скрипты.",
    d1: "Этот онлайн-форматтер и структуризатор JavaScript анализирует и реорганизует ваш код с последовательным отступом и единой структурой. Любой запутанный, минифицированный или плохо организованный скрипт превращается в хорошо читаемый и структурированный JavaScript всего за один клик.",
    d2: "Он удаляет ненужные пустые строки, исправляет отступы и нормализует пробелы вокруг операторов и скобок, что упрощает просмотр, отладку или передачу кода другим разработчикам.",
    plc: "Вставьте код JavaScript сюда или перетащите файл",
    bt: "Форматировать JavaScript",
    rst: "Начать заново",
    copy: "Копировать",
    err: "Ошибка",
    err_label: "Не удалось отформатировать JavaScript",
    how_it_works_title: "Как это работает",
    hiw_1_title: "Вставьте ваш JavaScript",
    hiw_1_desc: "Скопируйте и вставьте исходный, минифицированный или неформатированный JavaScript-код в редактор.",
    hiw_2_title: "Нажмите «Форматировать»",
    hiw_2_desc: "Нажмите кнопку «Форматировать JavaScript», и инструмент мгновенно перестроит скрипт.",
    ...
    uc_1_desc: "Приведите скрипты в порядок перед тем, как делиться ими с коллегами или создавать пулл-реквест.",
    uc_2_title: "Отладка кода",
    uc_2_desc: "Удобочитаемые отступы и последовательные пробелы значительно упрощают отслеживание логики и поиск багов.",
    uc_3_title: "Обучение и документация",
    uc_3_desc: "Правильно форматированный JavaScript легче читать, понимать и использовать в учебных руководствах или документации.",
    ...
    faq_2_q: "Поддерживает ли форматтер современный синтаксис JavaScript?",
    faq_2_a: "Да. Форматтер поддерживает современные возможности JavaScript, включая стандарты ES2020+, стрелочные функции, деструктуризацию, конструкции async/await и многое другое.",
    ...
    see1: "Минификатор JavaScript",
    see2: "Форматтер HTML",
    see3: "Форматтер CSS",
    see4: "Форматтер GraphQL",
    f_1: "Мгновенное форматирование и украшение JavaScript",
