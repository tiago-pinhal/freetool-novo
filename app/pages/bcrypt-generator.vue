...
<i18n lang="yaml">
{
  ...
  ru: {
    title: "Генератор и валидатор Bcrypt",
    meta: "Генерируйте безопасные хэши Bcrypt из любого текста с настраиваемым количеством раундов или проверяйте соответствие существующего хэша исходному тексту.",
    desc: "Bcrypt — это безопасный алгоритм хэширования, широко используемый для хранения паролей. Он добавляет уникальную соль к каждому хэшу для защиты от атак по радужным таблицам. Настройка раундов (Rounds) управляет вычислительной стоимостью: более высокие значения замедляют обработку, но значительно усложняют атаки методом перебора (брутфорс). Даже при использовании одного и того же текста каждый сгенерированный хэш будет уникальным.",
    check: "Проверить хэш",
    bt: "Сгенерировать хэш",
    features_title: "Возможности",
    plc: "Текст для хэширования",
    plcgen: "Хэш Bcrypt",
    plcver: "Исходный текст",
    match: "Хэш соответствует предоставленному тексту.",
    notmatch: "Хэш не соответствует предоставленному тексту.",
    rounds: "Фактор стоимости (Раунды)",
    see1: "MD5",
    see2: "Визуализатор JSON",
    see3: "Экстрактор e-mail",
    see4: "XML → JSON",
    tip: "Полезный совет:",
    result: "Результат",
    use_cases_title: "Примеры использования",
    uc_1_title: "Хранение паролей",
    uc_1_desc: "Безопасное хэширование паролей пользователей перед их сохранением в базу данных.",
    uc_2_title: "Тестирование безопасности",
    uc_2_desc: "Тестирование процессов аутентификации и входа в систему с использованием валидных хэшей Bcrypt.",
    uc_3_title: "Миграция систем",
    uc_3_desc: "Проверка и обновление старых хэшей паролей при миграции систем.",
    uc_4_title: "Обучение и разработка",
    uc_4_desc: "Понимание того, как соль и количество раундов влияют на безопасность хэша.",
    how_to_use_title: "Как использовать",
    step_1_title: "Сгенерировать хэш",
    step_1_desc: "Введите исходный текст, выберите количество раундов и нажмите «Сгенерировать хэш».",
    step_2_title: "Проверить хэш",
    step_2_desc: "Вставьте хэш Bcrypt, введите исходный текст и нажмите «Проверить хэш».",
    step_3_title: "Скопировать результаты",
    step_3_desc: "Используйте кнопку копирования рядом с хэшем или результатом сравнения для вашего приложения.",
    tip_rounds: "Раунды: более высокие значения повышают безопасность, но увеличивают время обработки.",
    tip_salt: "Соль: добавляется автоматически для предотвращения атак по радужным таблицам.",
    f_1: "Безопасная генерация хэшей Bcrypt",
    f_2: "Настраиваемое количество раундов (4–20)",
    f_3: "Проверка хэша в реальном времени",
    f_4: "Обработка на стороне клиента для максимальной конфиденциальности"
  }
}
</i18n>
