...
<i18n lang="yaml">
{
  en: {
    ...
    meta: "Random RG number generator for software testing and demonstrations. Create fictitious numbers in the standard format, safe and without real data. For educational and professional use only",
    ...
    d4: "It is important to emphasize that RG forgery is a crime punishable by law, and misuse of the information generated by this tool can result in serious legal consequences. Therefore, the use of the generator is strictly recommended for educational purposes, software testing, and legitimate demonstrations, with the user assuming full responsibility for the correct use of the generated data",
    num: "Numbers Only",
    bt: "Generate RG",
  ...
  pt: {
    ...
    title: "Gerador de RG", 
    meta: "Gerador de números de RG aleatórios para testes de software e demonstrações. Crie números fictícios no formato padrão, seguros e sem dados reais. Uso exclusivo para fins educacionais e profissionais",
    ...
    d4: "É importante destacar que a falsificação de RG é um crime previsto em lei, e o uso indevido das informações geradas por esta ferramenta pode acarretar sérias consequências legais. Portanto, o uso do gerador é estritamente recomendado para fins educacionais, testes de software e demonstrações legítimas, ficando a cargo do usuário a responsabilidade pelo uso correto dos dados gerados",
    num: "Somente Números",
    bt: "Gerar RG",
    placeholder: "Clique em Gerar RG para criar um número",
    rg_label: "RG Gerado",
    br: "Brasil",
  ...
  es: {
    ...
    meta: "Generador de números de RG aleatorios para pruebas de software y demostraciones. Cree números ficticios en el formato estándar, seguros y sin datos reales. Uso exclusivo para fines educativos y profesionales",
    ...
    d4: "Es importante destacar que la falsificación de RG es un delito previsto por la ley, y el uso indebido de la información generada por esta herramienta puede acarrear graves consecuencias legales. Por lo tanto, el uso del generador está estrictamente recomendado para fines educativos, pruebas de software y demostraciones legítimas, quedando a cargo del usuario la responsabilidad del uso correcto de los datos generados",
    num: "Solo Números",
    bt: "Generar RG",
  ...
  fr: {
    ...
    meta: "Générateur de numéros RG aléatoires pour tests logiciels et démonstrations. Créez des numéros fictifs au format standard, sécurisés et sans données réelles. Usage exclusivement éducatif et professionnel",
  ...
  it: {
    ...
    meta: "Generatore di numeri RG casuali per test software e dimostrazioni. Crea numeri fittizi nel formato standard, sicuri e senza dati reali. Uso esclusivo per scopi educativi e professionali",
    ...
    d4: "È importante sottolineare che la falsificazione del RG è un reato punito dalla legge e l'uso improprio delle informazioni generate da questo strumento può comportare gravi conseguenze legali. Pertanto, l'uso del generatore è strettamente raccomandato a fini educativi, test software e dimostrazioni legittime, con l'utente che si assume la piena responsabilità per l'uso corretto dei dati generati",
    num: "Solo Numeri",
    bt: "Genera RG",
  ...
  id: {
    ...
    meta: "Generator nomor RG acak untuk pengujian perangkat lunak dan demonstrasi. Buat nomor fiktif dalam format standar, aman dan tanpa data nyata. Penggunaan eksklusif untuk keperluan pendidikan dan profesional",
