...
<i18n lang="yaml">
{
  ...
  ru: {
    pageTitle: "Генератор RG — создать валидный номер RG для тестов онлайн | Бесплатно",
    title: "Генератор RG",
    meta: "Бесплатный онлайн-генератор случайных номеров RG (удостоверение личности Бразилии) для тестирования и разработки ПО. Безопасная генерация вымышленных номеров без реальных личных данных.",
    d1: "Registro Geral (RG) является основным гражданским удостоверением личности в Бразилии, используемым для подтверждения личности гражданина в различных повседневных ситуациях, таких как открытие банковских счетов, зачисление в учебные заведения, заключение договоров и другие юридические операции",
    d2: "Наш генератор случайных номеров RG разработан для упрощения создания вымышленных номеров RG, идеально подходящих для тестирования программного обеспечения, демонстрации систем и сред разработки. Этот инструмент особенно рекомендуется для разработчиков, тестировщиков (QA) и других ИТ-специалистов, которым необходимо валидировать процессы без использования реальных персональных данных",
    d3: "Инструмент генерирует случайные номера RG, которые не имеют никакой связи с реальными данными граждан, гарантируя конфиденциальность и безопасность при тестировании. Номера соответствуют официальному бразильскому стандарту формата RG, например, «99.999.999-9». Для большей гибкости вы можете выбрать опцию «Только цифры», которая генерирует номер RG без точек и дефисов, что упрощает ввод в базы данных или системы, требующие чистого числового формата",
    d4: "Важно подчеркнуть, что подделка удостоверения личности (RG) является преступлением, преследуемым по закону, и несанкционированное использование информации, полученной с помощью этого инструмента, может повлечь за собой серьезные юридические последствия. Использование генератора предназначено исключительно для образовательных целей, тестирования программного обеспечения и легитимных демонстраций, при этом пользователь несет полную ответственность за надлежащее использование сгенерированных данных",
    num: "Только цифры",
    bt: "Сгенерировать RG",
    placeholder: "Нажмите «Сгенерировать RG», чтобы создать номер",
    rg_label: "Сгенерированный RG",
    ...
    step_1_title: "Генерация одного RG",
    step_1_desc: "Выберите желаемый формат и нажмите «Сгенерировать RG». Созданный номер можно скопировать в буфер обмена одним кликом.",
    step_2_title: "С форматированием или без",
    step_2_desc: "Активируйте опцию «Только цифры», чтобы получить номер RG без точек и дефиса — это идеально подходит для интеграций и баз данных.",
    step_3_title: "Копирование результата",
    step_3_desc: "Созданный RG мгновенно отобразится на экране. Используйте кнопку копирования, чтобы перенести его в буфер обмена.",
    see1: "Генератор CPF",
    see2: "Генератор CNPJ",
