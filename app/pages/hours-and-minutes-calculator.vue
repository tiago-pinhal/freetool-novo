...
<i18n lang="yaml">
{
  ...
  pt: {
    ...
    pageTitle: "Calculadora de Horas e Minutos — Folha de Ponto Online",
    ...
    how_desc: "Calculadora de horas trabalhadas online e gratuita: some e subtraia horas e minutos para montar sua folha de ponto com precisão. Ideal para controle de ponto, faturamento de projetos ou conversão para o formato decimal exigido por softwares de RH e contabilidade. Informe seu valor/hora para visualizar o valor a receber instantaneamente.",
  ...
  nl: {
    ...
    faq3q: "Kan ik dit als een urenregistratie-calculator gebruiken?",
    faq3a: "Ja. Voeg de gewerkte uren voor elke periode toe en trek pauzes af. Het lopende totaal en de geschatte uitbetaling worden automatisch bijgewerkt, klaar om in te voeren in uw HR- of boekhoudsoftware.",
