...
defineI18nRoute({
  paths: {
    en: '/hours-and-minutes-calculator',
...
<i18n lang="yaml">
{
  en: {
    ...
    pageTitle: "Hours and Minutes Calculator — Timesheet & Decimal Hours",
    meta: "Free online hours and minutes calculator. Add or subtract time, convert to decimal hours, and calculate hourly pay instantly.",
    param_h: "Hours",
    param_m: "Minutes",
    btn_add: "Add",
    btn_sub: "Subtract",
    ...
    payout_label: "Payout",
    how_desc: "Calculate hours and minutes online with full timesheet support and instant decimal conversion. Add or subtract time entries to get precise accumulated totals, convert to decimal hours for payroll and accounting software, then enter your hourly rate to see your estimated gross pay instantly.",
    ...
    ex1: "Timesheet: add 3h 30m + 2h 45m and subtract 1h (lunch) — the calculator shows 5h 15m (5.25h).",
    ...
    faq2q: "How do I convert hours and minutes to decimal?",
    faq2a: "Just type the time — the calculator automatically shows the decimal value (e.g. 30 minutes = 0.5 hours) alongside the standard total. Payroll and accounting systems use decimal hours to calculate salaries, so you can copy the value directly into your software.",
    faq3q: "Can I use this as a timesheet calculator?",
    faq3a: "Yes. Add the hours worked for each period and subtract any breaks. The running total and estimated payout update automatically, ready to enter into HR or accounting software.",
    faq4q: "How do I calculate total hours worked for a full week?",
    faq4a: "Add each work period separately — Monday, Tuesday, Wednesday etc. — clicking Add each time. The calculator accumulates everything automatically and shows the weekly total in hours, minutes and decimal format, ready to enter into your timesheet.",
  ...
  pt: {
    ...
    pageTitle: "Calculadora de Horas Trabalhadas — Some e Subtraia Horas e Minutos",
    meta: "Calculadora online para calcular horas trabalhadas. Some e subtraia horas e minutos, converta para decimal e calcule o valor a receber.",
    param_h: "Horas",
    param_m: "Minutos",
    btn_add: "Adicionar",
    btn_sub: "Subtrair",
    ...
    how_desc: "Calculadora de horas trabalhadas online e gratuita para somar horas e minutos com precisão. Some ou subtraia intervalos de tempo para montar sua folha de ponto, converta para o formato decimal exigido por softwares de RH e contabilidade e informe seu valor/hora para visualizar o valor a receber instantaneamente.",
    ...
    ex1: "Somar horas trabalhadas: adicione 3h 30m + 2h 45m e subtraia 1h (almoço) — a calculadora mostra 5h 15m (5,25h).",
    ...
    faq3q: "Esta calculadora funciona como folha de ponto?",
    faq3a: "Sim. Adicione as horas trabalhadas em cada período e subtraia os intervalos. O total acumulado e o valor a receber são calculados automaticamente, prontos para lançar em sistemas de RH ou contabilidade.",
    faq4q: "Como calcular as horas trabalhadas da semana toda?",
    faq4a: "Adicione cada período de trabalho separadamente — segunda, terça, quarta etc. — clicando em Adicionar a cada vez. A calculadora acumula tudo automaticamente e exibe o total semanal em horas, minutos e formato decimal, pronto para lançar na folha de ponto.",
  ...
  es: {
    ...
    meta: "Calculadora de horas y minutos online y gratuita. Suma o resta tiempo, convierte a horas decimales y calcula tu pago por hora al instante.",
    param_h: "Horas",
    param_m: "Minutos",
    btn_add: "Añadir",
    btn_sub: "Restar",
    ...
    faq3q: "¿Puedo usar esta herramienta como calculadora de hoja de horas?",
    faq3a: "Sí. Añade las horas trabajadas en cada período y resta los descansos. El total acumulado y el pago estimado se actualizan automáticamente, listos para introducir en tu software de RRHH o contabilidad.",
    faq4q: "¿Cómo calculo las horas trabajadas de toda la semana?",
    faq4a: "Añade cada período de trabajo por separado — lunes, martes, miércoles etc. — haciendo clic en Añadir cada vez. La calculadora acumula todo automáticamente y muestra el total semanal en horas, minutos y formato decimal, listo para introducir en tu hoja de horas.",
  ...
  fr: {
    ...
    meta: "Calculatrice d'heures et de minutes en ligne. Additionnez, soustrayez du temps, convertissez en décimales et calculez votre salaire horaire.",
    param_h: "Heures",
    param_m: "Minutes",
    btn_add: "Ajouter",
    btn_sub: "Soustraire",
    ...
    faq3q: "Puis-je utiliser cet outil comme calculateur de feuille de temps ?",
    faq3a: "Oui. Ajoutez les heures travaillées pour chaque période et soustrayez les pauses. Le total cumulé et la rémunération estimée se mettent à jour automatiquement, prêts à être saisis dans votre logiciel RH ou de comptabilité.",
    faq4q: "Comment calculer les heures travaillées sur toute la semaine ?",
    faq4a: "Ajoutez chaque période de travail séparément — lundi, mardi, mercredi etc. — en cliquant sur Ajouter à chaque fois. Le calculateur accumule tout automatiquement et affiche le total hebdomadaire en heures, minutes et format décimal, prêt à saisir dans votre feuille de temps.",
  ...
  it: {
    ...
    meta: "Calcolatrice di ore e minuti online. Somma e sottrai tempo, converti in ore decimali e calcola il compenso orario all'istante.",
    param_h: "Ore",
    param_m: "Minuti",
    btn_add: "Aggiungi",
    btn_sub: "Sottrai",
    ...
    faq3q: "Posso usare questo strumento come calcolatrice per il foglio presenze?",
    faq3a: "Sì. Aggiungi le ore lavorate per ogni periodo e sottrai le pause. Il totale accumulato e il compenso stimato vengono aggiornati automaticamente, pronti per essere inseriti nel tuo software HR o di contabilità.",
    faq4q: "Come calcolo le ore lavorate nell'intera settimana?",
    faq4a: "Aggiungi ogni periodo di lavoro separatamente — lunedì, martedì, mercoledì ecc. — cliccando Aggiungi ogni volta. La calcolatrice accumula tutto automaticamente e mostra il totale settimanale in ore, minuti e formato decimale, pronto per essere inserito nel foglio presenze.",
  ...
  id: {
    ...
    meta: "Kalkulator jam dan menit online gratis. Tambah dan kurangi waktu, konversi ke jam desimal, dan hitung penghasilan per jam secara instan.",
    param_h: "Jam",
    param_m: "Menit",
    btn_add: "Tambah",
    btn_sub: "Kurangi",
    ...
    faq3q: "Apakah alat ini bisa digunakan sebagai kalkulator timesheet?",
    faq3a: "Ya. Tambahkan jam kerja untuk setiap periode dan kurangi waktu istirahat. Total akumulasi dan estimasi penghasilan diperbarui secara otomatis, siap dimasukkan ke perangkat lunak HR atau akuntansi Anda.",
    faq4q: "Bagaimana cara menghitung total jam kerja selama seminggu?",
    faq4a: "Tambahkan setiap periode kerja secara terpisah — Senin, Selasa, Rabu, dst. — dengan mengklik Tambah setiap kali. Kalkulator mengakumulasi semuanya secara otomatis dan menampilkan total mingguan dalam jam, menit, dan format desimal, siap dimasukkan ke timesheet Anda.",
    see1: "Selisih Waktu",
  ...
  de: {
    ...
    meta: "Kostenloser Online-Rechner für Stunden und Minuten. Addieren, subtrahieren, in Dezimalstunden umrechnen und Stundenlohn sofort berechnen.",
    param_h: "Stunden",
    param_m: "Minuten",
    btn_add: "Hinzufügen",
    btn_sub: "Abziehen",
    ...
    faq3q: "Kann ich dieses Tool als Stundenzettel-Rechner verwenden?",
    faq3a: "Ja. Geben Sie die Arbeitsstunden für jeden Zeitraum ein und ziehen Sie Pausen ab. Das laufende Gesamtergebnis und die voraussichtliche Auszahlung werden automatisch aktualisiert, bereit zur Eingabe in HR- oder Buchhaltungssoftware.",
    faq4q: "Wie berechne ich die gesamten Arbeitsstunden für eine ganze Woche?",
    faq4a: "Fügen Sie jeden Arbeitszeitraum einzeln hinzu — Montag, Dienstag, Mittwoch usw. — indem Sie jedes Mal auf Hinzufügen klicken. Der Rechner summiert alles automatisch und zeigt die Wochensumme in Stunden, Minuten und Dezimalformat an, bereit zur Eingabe in Ihren Stundenzettel.",
  ...
  nl: {
    title: "Uren Berekenen",
    pageTitle: "Uren Berekenen — Uren en Minuten Optellen en Aftrekken",
    meta: "Uren berekenen online en gratis. Tel uren en minuten op, trek af, zet om naar decimale uren en bereken uw uurloon.",
    param_h: "Uren",
    param_m: "Minuten",
    btn_add: "Toevoegen",
    btn_sub: "Aftrekken",
    ...
    how_desc: "Uren berekenen online en gratis: tel uren en minuten op of trek ze af om snel nauwkeurige totalen te krijgen. Ideaal voor urenregistratie, projectfacturatie of conversie naar het decimale formaat dat boekhoudsoftware vereist. Voer uw uurtarief in om direct de geschatte bruto-uitbetaling te zien.",
    features_title: "Functies",
    f_1: "Uren en minuten optellen en aftrekken in één doorlopend overzicht",
    ...
    ex1: "Uren optellen: tel 3u 30m + 2u 45m op en trek 1u (lunch) af — de calculator toont 5u 15m (5,25u).",
    ...
    faq3q: "Kan ik hiermee mijn uren berekenen voor urenregistratie?",
    faq3a: "Ja, u kunt uren berekenen voor elke periode door de gewerkte uren toe te voegen en pauzes af te trekken. Het lopende totaal en de geschatte uitbetaling worden automatisch bijgewerkt, klaar om in te voeren in uw HR- of boekhoudsoftware.",
    faq4q: "Hoe bereken ik de totale gewerkte uren voor een hele week?",
    faq4a: "Voeg elke werkperiode afzonderlijk toe — maandag, dinsdag, woensdag enz. — door elke keer op Toevoegen te klikken. De calculator accumuleert alles automatisch en toont het weektotaal in uren, minuten en decimaal formaat, klaar om in uw urenstaat in te voeren.",
  ...
  ru: {
    title: "Калькулятор часов и минут",
    pageTitle: "Калькулятор часов и минут — сложение и вычитание рабочего времени",
    meta: "Бесплатный онлайн-калькулятор часов и минут. Складывайте или вычитайте время, переводите часы в десятичный формат и мгновенно рассчитывайте оплату.",
    param_h: "Часы",
    param_m: "Минуты",
    btn_add: "Добавить",
    btn_sub: "Вычесть",
    btn_clear: "Очистить все",
    rate_label: "Почасовая ставка (опционально)",
    rate_placeholder: "например, 45.00",
    total_label: "Общее время",
    decimal_label: "Десятичный формат",
    payout_label: "Выплата",
    how_desc: "Удобный онлайн-калькулятор для сложения и вычитания часов и минут с мгновенным переводом в десятичные часы. Суммируйте или вычитайте временные интервалы (например, перерывы на обед) для учета рабочего времени, преобразуйте результат в десятичный формат для бухгалтерских программ и введите почасовую ставку, чтобы мгновенно рассчитать сумму к выплате.",
    features_title: "Возможности",
    f_1: "Последовательное сложение и вычитание нескольких временных интервалов",
    f_2: "Автоматический перевод итогового времени в десятичные часы",
    f_3: "Расчет суммы выплаты при указании почасовой ставки",
    f_4: "Поддержка отрицательных итогов — полезно для учета отработанного и недоработанного времени",
    use_cases_title: "Основные варианты использования",
    uc_1_title: "Фрилансеры и подрядчики",
    uc_1_desc: "Складывайте отработанные часы по различным проектам, вычитайте перерывы и мгновенно получайте итоговую сумму для выставления счета.",
    uc_2_title: "Отдел кадров и бухгалтерия",
    uc_2_desc: "Переводите стандартные часы и минуты в десятичный формат, необходимый для начисления зарплаты в учетных программах.",
    uc_3_title: "Журналы учета и оборудование",
    uc_3_desc: "Суммируйте часы налета в авиации, время работы оборудования или сервисные интервалы без необходимости вручную складывать минуты.",
    how_to_use_title: "Как пользоваться этим инструментом",
    step_1_title: "Введите значение времени",
    step_1_desc: "Введите часы и/или минуты в соответствующие поля.",
    step_2_title: "Сложите или вычтите",
    step_2_desc: "Нажмите «Добавить» для прибавления времени или «Вычесть» для его списания — например, для вычета обеденного перерыва.",
    step_3_title: "Ознакомьтесь с результатами",
    step_3_desc: "Итоговые значения обновляются мгновенно: отображается общее время в часах и минутах, десятичный эквивалент и расчетная выплата.",
    ex_title: "Популярные примеры",
    ex1: "Учет рабочего времени: сложите 3 ч. 30 мин. + 2 ч. 45 мин. и вычтите 1 ч. (обед) — калькулятор покажет 5 ч. 15 мин. (5.25 ч.).",
    ex2: "Оплата фриланса: после ввода 8 ч. 20 мин. при ставке $55/ч сумма к выплате автоматически составит $458.33.",
    ex3: "Время работы техники: складывайте ежедневные часы работы оборудования в течение недели, чтобы определить время до следующего техобслуживания.",
    faq_title: "Вопросы и ответы",
    faq1q: "Как вычесть обеденный перерыв?",
    faq1a: "Введите продолжительность перерыва в поля ввода (например, 1 час, 0 минут) и нажмите кнопку «Вычесть». Перерыв будет автоматически вычтен из общего накопленного времени.",
    faq2q: "Как перевести часы и минуты в десятичные часы?",
    faq2a: "Просто введите время — калькулятор автоматически отобразит десятичное значение (например, 30 минут = 0.5 часа) рядом с обычным итогом. Системы начисления зарплаты используют десятичные часы для расчетов, поэтому вы можете скопировать полученное число прямо в вашу бухгалтерскую программу.",
    faq3q: "Можно ли использовать этот инструмент для заполнения табеля рабочего времени?",
    faq3a: "Да. Добавляйте отработанное время за каждый период и вычитайте любые перерывы. Общий итог и расчетная сумма выплаты обновляются автоматически, позволяя сразу переносить данные в табель или учетную программу.",
    faq4q: "Как рассчитать общее количество отработанных часов за неделю?",
    faq4a: "Вводите каждый рабочий период отдельно (понедельник, вторник, среда и т. д.), нажимая кнопку «Добавить» после каждого ввода. Калькулятор автоматически просуммирует все данные и покажет недельный итог в часах, минутах и в десятичном формате, готовый для внесения в табель.",
    see1: "Разница во времени",
    see2: "Разница между датами и временем",
    see3: "Конвертер времени",
