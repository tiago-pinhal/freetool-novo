...
ru:
  title: "Разделить PDF"
  page_title: "Разделить PDF онлайн — бесплатное разделение страниц PDF"
  meta: "Быстро и безопасно разделяйте PDF-файлы на более мелкие документы прямо в браузере. Задавайте фиксированные или произвольные интервалы и скачивайте все в одном ZIP-архиве."
  intro: "Инструмент «Разделить PDF» позволяет разделять PDF-файл на несколько меньших документов с полным контролем над диапазонами страниц. Выберите автоматическое разделение на равные части или вручную укажите страницы для каждой части. Вся обработка происходит прямо в вашем браузере, гарантируя полную конфиденциальность."
  upload_hint: "Выберите PDF-файл для начала работы"
  click_upload: "Нажмите для загрузки"
  or_drag: "или перетащите его сюда"
  restart: "Начать заново"
  download: "Скачать файлы"
  downloading: "Скачивание..."
  tab_fixed: "Фиксированные интервалы"
  tab_custom: "Произвольные интервалы"
  pages_per_split: "Страниц в каждой части"
  total_pages: "Всего страниц"
  from_page: "От страницы"
  to_page: "До страницы"
  add_interval: "Добавить интервал"
  no_intervals_hint: "Добавьте как минимум один интервал, чтобы разделить PDF"
  preview: "Предпросмотр страницы"
  remove: "Удалить интервал"
  question: "Удалить этот диапазон страниц?"
  confirm: "Удалить"
  cancel: "Отмена"
  close: "Закрыть"
  err: "Произошла ошибка при попытке открыть файл"
  err_pass: "PDF-файл защищен паролем"
  no_intervals: "Укажите хотя бы один диапазон страниц для разделения"
  features_title: "Возможности разделения PDF"
  feature_1: "Автоматическое разделение на равные части с заданным интервалом"
  feature_2: "Произвольное разделение по конкретным страницам или гибким диапазонам"
  feature_3: "Предварительный просмотр страниц перед подтверждением разделения"
  feature_4: "Скачивание всех созданных PDF-файлов в одном ZIP-архиве"
  use_cases_title: "Когда нужно разделять PDF"
  use_cases_desc: "Разделение PDF полезно, когда вам нужно выделить части из большого документа или организованно распределить содержимое."
  uc_1_title: "Разделение на главы"
  uc_1_desc: "Разделяйте главы книг, учебные материалы, электронные книги или отчеты на отдельные файлы для удобства чтения или рассылки."
  uc_2_title: "Уменьшение размера файлов"
  uc_2_desc: "Делите большие PDF-файлы на более мелкие части для отправки по электронной почте или публикации на платформах с ограничениями на размер файлов."
  uc_3_title: "Организация отсканированных документов"
  uc_3_desc: "Разделяйте пакетно отсканированные документы по бланкам, формам или получателям, создавая упорядоченные отдельные файлы."
  uc_4_title: "Распределение по разделам"
  uc_4_desc: "Разделяйте PDF-файлы коммерческих предложений, руководств или презентаций по разделам, чтобы отправлять каждому получателю только актуальную информацию."
  how_to_title: "Как разделить PDF-файл"
  how_1_title: "Загрузите PDF-файл"
  how_1_desc: "Нажмите для загрузки или просто перетащите PDF-файл, который вы хотите разделить."
  how_2_title: "Задайте интервалы"
  how_2_desc: "Используйте фиксированные интервалы для разделения на равные части или создавайте собственные интервалы, точно указывая страницы для каждой части."
  how_3_title: "Скачайте файлы"
  how_3_desc: "Нажмите «Скачать файлы». Все созданные PDF-файлы будут упакованы в один ZIP-архив."
  faq_title: "Вопросы и ответы"
  faq_1_q: "В чем разница между фиксированными и произвольными интервалами?"
  faq_1_a: "Фиксированные интервалы автоматически разделяют PDF на части с одинаковым количеством страниц. Произвольные интервалы позволяют вручную задать начальную и конечную страницы для каждой части."
  faq_2_q: "В каком виде я получу файлы после разделения?"
  faq_2_a: "Все созданные PDF-файлы автоматически сжимаются в один ZIP-архив. Скачивание начнется сразу после завершения обработки."
  see1: "Редактор PDF"
  see2: "Изображение в PDF"
  see3: "Нумерация PDF"
  see4: "PDF в изображение"
</i18n>
