...
<i18n lang="yaml">
{
  ...
  ru: {
    m_title: "Конвертер JSON в XML онлайн — бесплатно и мгновенно",
    title: "Конвертер JSON в XML",
    meta: "Конвертируйте JSON в XML онлайн бесплатно. Вставьте JSON и получите чистый, валидный и хорошо структурированный XML без необходимости установки каких-либо программ.",
    d1: "Этот инструмент разбирает введенный JSON и преобразует каждую пару «ключ-значение», вложенный объект и массив в соответствующий XML-элемент. Ключи объектов становятся тегами XML, вложенные объекты — дочерними элементами, а элементы массивов оборачиваются в повторяющиеся теги, сохраняя исходную структуру данных.",
    bt: "Конвертировать",
    rst: "Начать заново",
    copy: "Копировать",
    ...
    hiw_1_title: "Вставьте JSON",
    hiw_1_desc: "Вставьте или перетащите файл JSON в редактор. Перед конвертацией убедитесь, что структура JSON корректна.",
    hiw_2_title: "Нажмите «Конвертировать»",
    hiw_2_desc: "Нажмите «Конвертировать», и инструмент мгновенно преобразует ваш JSON в чистый и хорошо структурированный XML-документ.",
    hiw_3_title: "Скопируйте XML",
    hiw_3_desc: "Готовый XML-код появится в редакторе. Нажмите кнопку «Копировать», чтобы скопировать его в буфер обмена.",
    use_cases_title: "Варианты использования",
    uc_1_title: "SOAP и веб-службы",
    uc_1_desc: "Преобразуйте полезную нагрузку JSON в XML-формат для интеграции с SOAP-службами и корпоративными API, которые принимают исключительно XML.",
    uc_2_title: "Интеграция с устаревшими системами",
    uc_2_desc: "Преобразуйте современные данные JSON в XML для обмена данными с устаревшими корпоративными системами, платформами или связующим ПО (middleware).",
    uc_3_title: "Файлы конфигурации",
    uc_3_desc: "Конвертируйте конфигурационные объекты JSON в формат XML для инструментов, фреймворков и систем, использующих файлы конфигурации на базе XML.",
    faq_title: "Вопросы и ответы",
    faq_1_q: "Отправляются ли мои данные JSON на сервер?",
    faq_1_a: "Нет. Конвертация выполняется полностью внутри вашего браузера. Ваши данные никогда не покидают ваше устройство.",
    faq_2_q: "Что происходит с вложенными объектами JSON?",
    faq_2_a: "Вложенные объекты преобразуются во вложенные дочерние элементы XML, сохраняя исходную иерархию ваших данных.",
    faq_3_q: "Как обрабатываются массивы JSON?",
    faq_3_a: "Каждый элемент массива JSON оборачивается в повторяющийся XML-тег с именем родительского ключа, что позволяет сохранить целостность структуры массива.",
    see1: "XML → JSON",
    see2: "CSV → JSON",
    see3: "JSON → CSV",
    see4: "LESS → CSS",
    f_1: "Мгновенная конвертация JSON в XML",
    f_2: "Обработка вложенных объектов и массивов",
    f_3: "Генерация валидного и структурированного XML",
