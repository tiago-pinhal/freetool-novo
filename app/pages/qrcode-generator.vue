...
<i18n lang="yaml">
{
  en: {
    ...
    page_title: "Free Custom QR Code Generator & Maker with Logo",
    meta: "Free custom QR code generator with logo. Create QR codes for URL, Wi-Fi, vCard and PIX. Customize colors, shapes and download as PNG.",
    og_title: "Free Custom QR Code Generator with Logo",
    intro: "Create custom QR codes with logo for free — no sign-up required. Our QR code maker runs entirely in your browser, ensuring your data never leaves your device. Ideal for printed and digital materials.",
    data: "QR Code Data",
    data_opt: "Data type",
    text: "Text",
    ...
    faq_5_q: "How do I create a custom QR code for free?",
    faq_5_a: "Choose the content type (URL, Wi-Fi, vCard, PIX…), fill in the fields, customize colors and style, then click Download. No registration required.",
    see1: "Emoji Picker",
  ...
  pt: {
    ...
    page_title: "Gerador de QR Code Personalizado com Logo - Grátis e Online",
    meta: "Gerador de QR Code personalizado com logo, grátis e online. Crie QR Codes para URL, Wi-Fi, vCard e PIX. Personalize cores, formatos e baixe em PNG.",
    og_title: "Gerador de QR Code Personalizado com Logo Grátis",
    intro: "Crie QR Codes personalizados com logo de forma gratuita — sem cadastro. Nosso criador de QR Code funciona inteiramente no navegador, garantindo que seus dados não saiam do seu dispositivo. Ideal para materiais impressos e digitais.",
    ...
    faq_5_q: "Como criar um QR Code personalizado de graça?",
    faq_5_a: "Escolha o tipo de conteúdo (URL, Wi-Fi, vCard, PIX…), preencha os campos, personalize cores e estilo, e clique em Download. Sem necessidade de cadastro.",
  ...
  es: {
    ...
    page_title: "Generador de Código QR Personalizado con Logo - Gratis y Online",
    meta: "Generador de código QR personalizado con logo, gratis y online. Crea códigos QR para URL, Wi-Fi, vCard y PIX. Personaliza colores, formas y descarga en PNG.",
    og_title: "Generador de Código QR Personalizado con Logo Gratis",
    intro: "Crea códigos QR personalizados con logo gratis — sin registro. Nuestro creador de códigos QR funciona totalmente en el navegador, garantizando que sus datos no salgan de su dispositivo. Ideal para materiales impresos y digitales.",
    ...
    faq_5_q: "¿Cómo crear un código QR personalizado gratis?",
    faq_5_a: "Elige el tipo de contenido (URL, Wi-Fi, vCard, PIX…), rellena los campos, personaliza colores y estilo, y haz clic en Descargar. Sin necesidad de registro.",
  ...
  fr: {
    ...
    faq_5_q: "Comment créer un code QR personnalisé gratuitement ?",
    faq_5_a: "Choisissez le type de contenu (URL, Wi-Fi, vCard, PIX…), remplissez les champs, personnalisez les couleurs et le style, puis cliquez sur Télécharger. Sans inscription requise.",
  ...
  it: {
    ...
    faq_5_q: "Come creare un codice QR personalizzato gratis?",
    faq_5_a: "Scegli il tipo di contenuto (URL, Wi-Fi, vCard, PIX…), compila i campi, personalizza colori e stile, poi clicca su Scarica. Senza necessità di registrazione.",
  ...
  id: {
    ...
    faq_5_q: "Bagaimana cara membuat kode QR kustom secara gratis?",
    faq_5_a: "Pilih jenis konten (URL, Wi-Fi, vCard, PIX…), isi bidang, sesuaikan warna dan gaya, lalu klik Unduh. Tanpa perlu mendaftar.",
    see1: "Pemilih Emoji",
  ...
  de: {
    ...
    faq_5_q: "Wie erstelle ich kostenlos einen benutzerdefinierten QR-Code?",
    faq_5_a: "Wählen Sie den Inhaltstyp (URL, WLAN, vCard, PIX…), füllen Sie die Felder aus, passen Sie Farben und Stil an und klicken Sie auf Herunterladen. Keine Registrierung erforderlich.",
  ...
  nl: {
    title: "QR Code Generator",
    page_title: "QR-code generator met logo - Maak gratis een aangepaste QR-code",
    ...
    features_title: "Functies van de QR-code generator",
    ...
    faq_5_q: "Hoe maak ik gratis een aangepaste QR-code?",
    faq_5_a: "Kies het inhoudstype (URL, wifi, vCard, PIX…), vul de velden in, pas kleuren en stijl aan en klik op Downloaden. Geen registratie nodig.",
  ...
  ru: {
    ...
    page_title: "Бесплатный генератор QR-кодов с логотипом онлайн",
    meta: "Бесплатный онлайн-генератор QR-кодов с возможностью добавить логотип. Создавайте QR-коды для ссылок (URL), Wi-Fi, визиток vCard и PIX. Настраивайте цвета, формы и скачивайте в PNG.",
    og_title: "Бесплатный генератор QR-кодов с логотипом",
    intro: "Создавайте уникальные QR-коды с логотипом бесплатно и без регистрации. Наш генератор работает прямо в вашем браузере, поэтому ваши данные остаются в полной безопасности и не передаются на сервер. Идеально подходит для печатной продукции и цифровых материалов.",
    data: "Данные QR-кода",
    data_opt: "Тип данных",
    text: "Текст",
    text_placeholder: "Введите текст, который будет зашифрован в QR-коде",
    first_name: "Имя",
    last_name: "Фамилия",
    address: "Адрес",
    street: "Улица, дом",
    ...
    msg: "Сообщение",
    ssid: "Имя сети (SSID)",
    cripto: "Тип шифрования",
    none: "Без пароля",
    hidden: "Скрытая сеть Wi-Fi",
    pass: "Пароль",
    pix_key: "Ключ PIX",
    pix_name: "Имя получателя",
    pix_city: "Город",
    pix_amount: "Сумма",
    colors_label: "Цвета",
    ...
    margin: "Отступ",
    logo: "Логотип",
    logo_help: "Добавьте изображение в центр QR-кода и обязательно проверьте считывание перед печатью.",
    choose_logo: "Выбрать логотип",
    logo_margin: "Отступ логотипа",
    hide: "Скрывать пиксели под логотипом",
    remove: "Удалить",
    dot_style: "Форма пикселей",
    corner_style: "Форма угловых рамок",
    square: "Квадрат",
    dots: "Точки",
    rounded: "Скругленный",
    classy: "Изящный",
    dot_color: "Пиксели",
    corners_color: "Рамки",
    corners_dot_color: "Угловые точки",
    bck_clr: "Фон",
    preview: "Предпросмотр",
    scan_tip: "Совет: используйте контрастные цвета для пикселей и фона, чтобы QR-код легко сканировался.",
    download_aria: "Скачать QR-код в формате PNG",
    download_success: "QR-код успешно скачан.",
    features_title: "Возможности генератора QR-кодов",
    feature_1: "Создание QR-кодов для ссылок (URL), визиток vCard, сетей Wi-Fi, PIX-платежей, Email, SMS и простого текста",
    feature_2: "Гибкая настройка цвета, формы пикселей, угловых рамок, размера и отступов",
    feature_3: "Добавление логотипа в центр с регулировкой отступов и скрытием фона под ним",
    feature_4: "Скачивание в высоком разрешении PNG, готовом для печати любого формата",
    use_cases_title: "Где использовать собственные QR-коды",
    use_cases_desc: "QR-коды помогают связать физические носители с цифровым пространством, избавляя пользователей от необходимости вводить адреса сайтов или контактные данные вручную.",
    uc_1_title: "Маркетинг и полиграфия",
    uc_1_desc: "Размещайте QR-коды на визитках, буклетах, упаковке товаров, баннерах и плакатах для мгновенного перехода на сайты, каталоги, купоны или промо-страницы.",
    uc_2_title: "Цифровая визитка",
    uc_2_desc: "Используйте формат vCard, чтобы поделиться именем, телефоном, почтой, должностью, адресом и сайтом за одно сканирование.",
    uc_3_title: "Быстрое подключение к Wi-Fi",
    uc_3_desc: "Создайте QR-код для подключения гостей или клиентов к беспроводной сети без ручного ввода пароля.",
    uc_4_title: "Сервис и коммуникации",
    uc_4_desc: "Генерируйте QR-коды с предзаполненными SMS или письмами для упрощения обратной связи, техподдержки, бронирования или запроса цен.",
    how_to_title: "Как создать QR-код",
    how_1_title: "Выберите тип содержимого",
    how_1_desc: "Выберите нужный формат данных и заполните предложенные поля.",
    how_2_title: "Настройте дизайн",
    how_2_desc: "Измените размер, отступы, цветовую гамму, форму пикселей и рамок. При желании загрузите логотип вашего бренда в центр.",
    how_3_title: "Проверьте и скачайте в PNG",
    how_3_desc: "Взгляните на предпросмотр, отсканируйте код смартфоном для проверки и скачайте готовый файл PNG.",
    types_title: "Поддерживаемые форматы QR-кодов",
    types_desc: "Каждый тип данных формирует структуру, которая мгновенно распознается стандартными камерами современных смартфонов.",
    type_url: "URL: направляет пользователя на веб-сайт, целевую страницу, онлайн-меню, форму заказа или профиль в соцсетях.",
    type_vcard: "vCard: быстро сохраняет все контактные данные в телефонную книгу пользователя.",
    type_email: "Email: открывает почтовое приложение с предзаполненными адресом получателя, темой и текстом сообщения.",
    type_wifi: "Wi-Fi: позволяет быстро подключиться к беспроводной сети (передает имя сети, пароль и тип шифрования).",
    type_sms: "SMS: подготавливает текстовое сообщение на указанный номер с готовым текстом.",
    type_pix: "PIX: создает статический QR-код для приема быстрых платежей и денежных переводов (для Бразилии).",
    type_text: "Текст: хранит любую текстовую информацию, которая отображается на экране сразу после сканирования.",
    faq_title: "Часто задаваемые вопросы",
    faq_1_q: "Можно ли добавить логотип на QR-код?",
    faq_1_a: "Да. С помощью функции загрузки логотипа вы можете добавить изображение в центр кода. Для обеспечения высокой считываемости выбирайте не слишком сложные логотипы и проверяйте код камерой перед печатью.",
    faq_3_q: "Будет ли QR-код работать, если изменить его цвет и форму?",
    faq_3_a: "Да, главное — сохранять высокую контрастность между пикселями и фоном. Избегайте слишком светлых тонов для элементов рисунка и всегда проверяйте считывание на реальном телефоне.",
    faq_4_q: "В каком формате скачивается готовый файл?",
    faq_4_a: "Изображения генерируются в формате PNG высокого разрешения, который отлично подходит как для цифровых экранов, так и для качественной полиграфической печати.",
    faq_5_q: "Как создать персонализированный QR-код бесплатно?",
    faq_5_a: "Выберите формат данных (ссылка, Wi-Fi, визитка и т. д.), заполните поля, настройте цвет и форму элементов, а затем нажмите кнопку «Скачать». Никакой регистрации не требуется.",
    see1: "Выбор эмодзи",
    ...
    pix_key_placeholder: "CPF, Email, телефон или случайный ключ",
    pix_desc_placeholder: "Описание",
    pix_note: "Примечание: создаваемый PIX QR-код является статическим. Пожалуйста, внимательно сверяйте все реквизиты перед отправкой.",
    pix_empty: "Укажите ключ PIX для генерации QR-кода",
    unlink: "Разблокировать соотношение сторон",
    link: "Сохранять соотношение сторон",
    scaled_preview: "Уменьшенный предпросмотр",
    pix: "PIX (Бразилия)"
  }
}
</i18n>
