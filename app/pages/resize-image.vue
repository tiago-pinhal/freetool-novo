...
fr:
  ...
  pageTitle: "Redimensionner Image en Ligne : Ajustez vos Photos avec des Modèles de Taille Professionnels"
  meta: "Outil rapide et précis pour redimensionner des images. Utilisez des modèles de taille pour Instagram, YouTube, e-commerce ou définissez des tailles personnalisées en haute qualité."
  metaDescription: "Redimensionnez des images en ligne gratuitement. Choisissez des dimensions personnalisées ou utilisez des modèles pour Instagram, YouTube et les stores d'applications. Redimensionnement de haute qualité."
  d1: "Ajustez la taille de vos photos et images avec une précision professionnelle de manière simple et rapide. Utilisez nos modèles de taille intelligents pour les réseaux sociaux ou configurez des dimensions personnalisées pour garantir un rendu parfait sur n'importe quel écran ou support imprimé."
  t2: "Fonctionnalités"
  d21: "30+ tailles prédéfinies organisées par catégorie"
  d22: "Dimensions personnalisées avec verrouillage du ratio"
  ...
  catAppStore: "Store d'Apps"
  catAppStoreDesc: "Icônes, captures d'écran et graphiques promotionnels pour apps mobiles"
  ...
  how1d: "Cliquez pour envoyer l'image que vous souhaitez redimensionner. Le fichier est traité localement dans le navigateur, sans envoi sur serveur."
  how2t: "Choisissez le mode et la taille finale"
  how2d: "Utilisez un modèle de taille, renseignez des dimensions libres en pixels ou appliquez un pourcentage pour réduire ou agrandir l'image."
  ...
  faq1a: "Les icônes d'application doivent faire 512x512 pixels pour Google Play et 1024x1024 pour l'App Store. Sélectionnez la catégorie 'Store d'Apps' et choisissez le modèle approprié."
  faq2q: "Comment redimensionner une image pour Instagram sans la rogner ?"
  faq2a: "Utilisez le mode par pourcentage pour une mise à l'échelle proportionnelle. Pour le feed Instagram, redimensionnez pour tenir dans 1080px de large. Pour les Stories, utilisez 1080x1920 si le ratio de l'image le permet."
  faq3q: "Quelle est la meilleure taille pour une miniature YouTube ?"
  faq3a: "Les miniatures YouTube doivent faire 1280x720 pixels, avec un ratio 16:9. Sélectionnez 'Réseaux Sociaux' et choisissez 'YouTube Thumbnail'."
  faq4q: "Comment réduire la taille du fichier sans perdre de qualité ?"
  faq4a: "L'outil utilise une technologie de redimensionnement professionnelle qui préserve la netteté. Pour des fichiers plus petits, exportez en WebP ou JPEG avec une qualité élevée."
  faq5q: "Puis-je redimensionner une image à des pixels spécifiques ?"
  faq5a: "Oui. Utilisez le mode 'Dimensions Personnalisées' et saisissez la largeur et la hauteur exactes en pixels. Activez 'Verrouiller le ratio' pour recalculer automatiquement l'autre dimension."
  uploadHint: "Prend en charge JPG, PNG, WebP, GIF et plus"
  original: "Original"
  chooseMode: "Choisir comment redimensionner"
  modePreset: "Modèles de Taille"
  modeCustom: "Dimensions Personnalisées"
  modePercentage: "Par Pourcentage"
  chooseCategory: "Choisir une catégorie"
  chooseSize: "Choisir la taille finale"
  choosePercentage: "Choisir un pourcentage"
  width: "Largeur (px)"
  height: "Hauteur (px)"
  lockRatio: "Maintenir le ratio"
  result: "Résultat"
...
it:
  ...
  pageTitle: "Ridimensiona Immagine Online: Regola le Foto con Modelli di Dimensione Professionali"
  meta: "Strumento rapido e preciso per ridimensionare immagini. Usa modelli di dimensione per Instagram, YouTube, e-commerce o imposta dimensioni personalizzate in alta qualità."
  metaDescription: "Ridimensiona immagini online gratuitamente. Scegli dimensioni personalizzate o usa modelli di dimensione per Instagram, YouTube e store di app. Ridimensionamento di alta qualità."
  d1: "Regola le dimensioni delle tue foto e immagini con precisione professionale in modo semplice e veloce. Utilizza i nostri modelli di dimensione intelligenti per i social network o configura dimensioni personalizzate per garantire un risultato perfetto su qualsiasi schermo o supporto stampato."
  t2: "Funzionalità"
  ...
  how1d: "Clicca per inviare l'immagine che desideri ridimensionare. Il file viene elaborato localmente nel browser, senza caricamento sui server."
  how2t: "Scegli la modalità e la dimensione finale"
  how2d: "Usa un modello di dimensione, inserisci dimensioni libere in pixel o applica una percentuale per ridurre o ingrandire l'immagine."
  ...
  faq1a: "Le icone delle app devono essere 512x512 pixel per Google Play e 1024x1024 per l'App Store. Seleziona la categoria 'Store di App' e scegli il modello appropriato."
  faq2q: "Come ridimensionare un'immagine per Instagram senza ritagliarla?"
  faq2a: "Usa la modalità percentuale per scalare proporzionalmente. Per il feed di Instagram, ridimensiona per adattarlo a 1080px di larghezza. Per le Stories, usa 1080x1920 se le proporzioni dell'immagine lo permettono."
  faq3q: "Qual è la dimensione migliore per la miniatura di YouTube?"
  faq3a: "Le miniature di YouTube devono essere 1280x720 pixel, con un rapporto 16:9. Seleziona 'Social Network' e scegli 'YouTube Thumbnail'."
  faq4q: "Come ridurre la dimensione del file senza perdere qualità?"
  faq4a: "Lo strumento utilizza una tecnologia di ridimensionamento professionale che preserva la nitidezza. Per file più piccoli, esporta come WebP o JPEG con alta qualità."
  ...
  modePreset: "Modelli di Dimensione"
...
id:
  ...
  pageTitle: "Ubah Ukuran Gambar Online: Sesuaikan Foto dengan Model Ukuran Profesional"
  meta: "Alat cepat dan akurat untuk mengubah ukuran gambar. Gunakan model ukuran untuk Instagram, YouTube, e-commerce, atau atur ukuran khusus dengan kualitas tinggi."
  metaDescription: "Ubah ukuran gambar online gratis. Pilih dimensi khusus atau gunakan model ukuran untuk Instagram, YouTube, dan toko aplikasi. Pengubahan ukuran kualitas tinggi."
  d1: "Sesuaikan ukuran foto dan gambar Anda dengan presisi profesional secara sederhana dan cepat. Gunakan model ukuran cerdas kami untuk media sosial atau konfigurasi dimensi khusus untuk memastikan hasil sempurna di layar atau media cetak apa pun."
  t2: "Fitur"
  d21: "30+ ukuran yang ditentukan sebelumnya diatur berdasarkan kategori"
  ...
  how1d: "Klik untuk mengunggah gambar yang ingin Anda ubah ukurannya. File diproses secara lokal di browser, tanpa unggah ke server."
  how2t: "Pilih mode dan ukuran akhir"
  how2d: "Gunakan model ukuran, masukkan dimensi piksel bebas, atau terapkan persentase untuk memperkecil atau memperbesar gambar."
  ...
  faq1a: "Ikon aplikasi harus berukuran 512x512 piksel untuk Google Play dan 1024x1024 untuk App Store. Pilih kategori 'Toko Aplikasi' dan pilih model yang sesuai."
  faq2q: "Bagaimana cara mengubah ukuran gambar untuk Instagram tanpa memotong?"
  faq2a: "Gunakan mode persentase untuk menskalakan secara proporsional. Untuk feed Instagram, ubah ukuran agar sesuai dengan lebar 1080px. Untuk Stories, gunakan 1080x1920 jika rasio gambar memungkinkan."
  faq3q: "Berapa ukuran terbaik untuk thumbnail YouTube?"
  faq3a: "Thumbnail YouTube harus berukuran 1280x720 piksel, dengan rasio 16:9. Pilih 'Media Sosial' dan pilih 'YouTube Thumbnail'."
  ...
  faq5a: "Ya. Gunakan mode 'Dimensi Khusus' dan masukkan lebar dan tinggi yang tepat dalam piksel. Aktifkan 'Jaga rasio aspek' untuk menghitung ulang dimensi lainnya secara otomatis."
  uploadHint: "Mendukung JPG, PNG, WebP, GIF, dan lainnya"
  original: "Asli"
  chooseMode: "Pilih cara mengubah ukuran"
  modePreset: "Model Ukuran"
...
de:
  ...
  pageTitle: "Bildgröße online ändern - Kostenloses Tool mit Vorlagen"
  meta: "Ändere Bilder auf exakte Abmessungen mit vordefinierten Größen für App Stores, soziale Netzwerke, Web und Druck"
  metaDescription: "Bilder online kostenlos skalieren. Verwende Vorlagen für App Stores, soziale Medien, Web und Druck. Hochwertige Bildskalierung für scharfe Ergebnisse."
  ...
  t2: "Funktionen"
  d21: "30+ Größenmodelle nach Kategorie organisiert"
  ...
  how2d: "Verwende ein Größenmodell, gib freie Pixelmaße ein oder wende einen Prozentsatz an, um das Bild zu verkleinern oder zu vergrößern."
  ...
  faq1a: "App-Symbole sollten für Google Play und den App Store 512×512 Pixel haben. Wähle die Kategorie 'App Store' und das passende Modell für die exakten Abmessungen."
  ...
  faq5a: "Ja. Verwende den Modus 'Freie Größe' und gib die exakte Breite und Höhe in Pixeln ein. Aktiviere 'Seitenverhältnis beibehalten', damit die andere Dimension automatisch berechnet wird."
  uploadHint: "Unterstützt JPG, PNG, WebP, GIF und mehr"
  original: "Original"
  chooseMode: "Wie möchtest du die Bildgröße ändern?"
  modePreset: "Größenmodelle"
...
nl:
  ...
  pageTitle: "Online afbeelding verkleinen - Gratis tool met modellen"
  meta: "Verklein afbeeldingen naar exacte afmetingen met vooraf ingestelde modellen voor app stores, sociale media, web en drukwerk"
  metaDescription: "Verklein afbeeldingen gratis online. Gebruik modellen voor app stores, sociale media, web en drukwerk. Hoogwaardige beeldskalering voor scherpe resultaten."
  ogTitle: "Afbeelding verkleinen - Gratis online tool"
  ogLocale: "nl_NL"
  d1: "Alle verwerking vindt lokaal plaats in je browser - je afbeeldingen worden nooit naar een server verzonden."
  t2: "Functies"
  d21: "30+ Grootte-modellen georganiseerd per categorie"
  ...
  catEcommerce: "E-commerce"
  catEcommerceDesc: "Productafbeeldingen en promotieheaders"
  catPrint: "Drukwerk"
  catPrintDesc: "A4, A5, foto's en visitekaartjes"
  t5: "Hoe het werkt"
  how1t: "Upload je afbeelding"
  how1d: "Klik om de afbeelding te uploaden die je wilt verkleinen. Het bestand wordt lokaal in je browser verwerkt en niet naar een server verzonden."
  how2t: "Kies modus en eindformaat"
  how2d: "Gebruik een vooraf ingesteld model, voer vrije pixelmaten in of pas een percentage toe om de afbeelding te verkleinen of te vergroten."
  ...
  faqTitle: "Vraag en Antwoord"
  faq1q: "Welke maat moet een app store-pictogram hebben?"
  faq1a: "App-pictogrammen moeten 512×512 pixels zijn voor Google Play en 1024×1024 voor de App Store. Selecteer de categorie 'App Store' en kies het juiste model voor de exacte afmetingen."
  faq2q: "Hoe verander ik de grootte van een afbeelding voor Instagram zonder bijsnijden?"
  faq2a: "Gebruik de percentagemodus om proportioneel te schalen. Voor de Instagram-feed past u de breedte aan naar 1080 px. Voor Stories gebruikt u 1080×1920 als de beeldverhouding van de afbeelding dit toelaat."
  ...
  faq4a: "De tool maakt gebruik van professionele schaaltechnologie die de scherpte behoudt. Voor kleinere bestanden exporteert u als WebP of JPEG met hoge kwaliteit."
