...
defineI18nRoute({
  paths: {
    ...
    ru: '/izmenit-razmer-izobrazheniya',
  },
})
</script>
...
en:
  ...
  ogLocale: "en_US"
  d1: "This free image resizer lets you resize images online to exact pixel dimensions without installing any software. Use ready-made size presets for social media, app stores, e-commerce, and print, or enter custom dimensions. All processing happens locally in your browser — your images are never uploaded to any server."
  t2: "Features"
...
pt:
  ...
  ogTitle: "Redimensionar Imagem - Ferramenta Online Grátis"
  ogLocale: "pt_BR"
...
es:
  ...
  ogLocale: "es_ES"
  d1: "Esta herramienta gratuita para redimensionar imagen online te permite ajustar imágenes a dimensiones exactas en píxeles sin instalar ningún software. Usa modelos de tamaño predefinidos para redes sociales, tiendas de apps, e-commerce e impresión, o introduce dimensiones personalizadas. Todo el procesamiento ocurre localmente en tu navegador — tus imágenes nunca se suben a ningún servidor."
  t2: "Funciones"
...
fr:
  ...
  ogTitle: "Redimensionner une Image - Outil en Ligne Gratuit"
  ogLocale: "fr_FR"
...
it:
  ...
  ogTitle: "Ridimensiona Immagine - Strumento Online Gratuito"
  ogLocale: "it_IT"
...
id:
  ...
  ogTitle: "Ubah Ukuran Gambar - Alat Online Gratis"
  ogLocale: "id_ID"
...
de:
  ...
  ogLocale: "de_DE"
  d1: "Mit diesem kostenlosen Tool zum Bildgröße ändern online kannst du Bilder auf genaue Pixelmaße anpassen, ohne Software zu installieren. Nutze fertige Größenvorlagen für soziale Medien, App Stores, E-Commerce und Druck oder gib eigene Abmessungen ein. Die gesamte Verarbeitung findet lokal in deinem Browser statt — deine Bilder werden niemals auf einen Server hochgeladen."
  t2: "Funktionen"
...
nl:
  ...
  ogLocale: "nl_NL"
  d1: "Met deze gratis tool voor het schalen van afbeeldingen online pas je foto's aan naar exacte pixelafmetingen zonder software te installeren. Gebruik kant-en-klare formaatvoorinstellingen voor sociale media, appstores, e-commerce en drukwerk, of voer eigen afmetingen in. Alle verwerking vindt lokaal plaats in je browser — je afbeeldingen worden nooit naar een server verzonden."
  t2: "Functies"
...
ru:
  ...
  pageTitle: "Изменение размера изображений онлайн: шаблоны размеров"
  meta: "Бесплатный онлайн-инструмент для изменения размера изображений под стандарты магазинов приложений, соцсетей, сайтов и печати."
  metaDescription: "Изменение размера изображений онлайн бесплатно. Удобные шаблоны для магазинов приложений (App Store, Google Play), социальных сетей (Instagram, YouTube, TikTok), веб-сайтов и печати. Высокое качество без потери четкости."
  ogTitle: "Изменение размера изображений — бесплатный онлайн-инструмент"
  ogLocale: "ru_RU"
  d1: "Этот бесплатный инструмент позволяет изменить размер изображения онлайн до точных пикселей без установки каких-либо программ. Используйте готовые шаблоны для соцсетей, магазинов приложений, интернет-магазинов и печати или задайте собственные размеры. Вся обработка происходит прямо в вашем браузере — файлы не отправляются на сервер."
  t2: "Возможности"
  d21: "Более 30 готовых размеров, разделенных по категориям"
  d22: "Настройка собственных размеров с сохранением пропорций"
  d23: "Быстрое масштабирование в процентах (25%, 50%, 150%, 200%)"
  d24: "Профессиональное качество ресайза с высокой четкостью линий"
  d25: "Экспорт в форматы PNG, JPEG или WebP"
  t3: "Размеры по категориям"
  d3: "Оптимальные пропорции и разрешения для любых нужд"
  catAppStore: "Магазины приложений"
  catAppStoreDesc: "Иконки, скриншоты и баннеры для мобильных приложений"
  catSocial: "Социальные сети"
  catSocialDesc: "Оптимальные размеры для Instagram, YouTube, TikTok, Facebook, LinkedIn"
  catWeb: "Веб и экраны"
  catWebDesc: "Фавиконки, OG-изображения для соцсетей, обои рабочего стола и веб-баннеры"
  catEcommerce: "Интернет-магазины"
  catEcommerceDesc: "Карточки товаров, превью и рекламные баннеры для маркетплейсов"
  catPrint: "Печать"
  catPrintDesc: "Форматы A4, A5, стандартные фотографии и визитки"
  t5: "Как пользоваться"
  how1t: "Загрузите изображение"
  how1d: "Нажмите кнопку загрузки или перетащите файл. Изображение обрабатывается локально в вашем браузере и не передается на внешние серверы."
  how2t: "Выберите режим и размер"
  how2d: "Выберите подходящий готовый шаблон, укажите произвольные размеры в пикселях или примените масштабирование в процентах."
  how3t: "Выберите формат и скачайте"
  how3d: "Выберите PNG для максимального качества, JPEG для меньшего размера файла или WebP как современный эффективный формат, после чего скачайте готовый файл."
  faqTitle: "Часто задаваемые вопросы"
  faq1q: "Какого размера должна быть иконка приложения?"
  faq1a: "Иконка приложения должна иметь размер 512×512 пикселей для Google Play и 1024×1024 для App Store. Перейдите в категорию «Магазины приложений» и выберите соответствующий пресет."
  faq2q: "Как изменить размер фото для Instagram без обрезки?"
  faq2a: "Используйте режим масштабирования в процентах для пропорционального изменения. Для ленты Instagram оптимально установить ширину в 1080 пикселей. Для Stories используйте формат 1080×1920, если исходные пропорции позволяют."
  faq3q: "Каков лучший размер для обложки YouTube?"
  faq3a: "Превью-обложки для YouTube должны иметь разрешение 1280×720 пикселей (соотношение сторон 16:9). Выберите категорию «Социальные сети», затем пункт «YouTube Thumbnail»."
  faq4q: "Как уменьшить вес картинки без потери качества?"
  faq4a: "Инструмент использует профессиональный алгоритм ресайза, сохраняющий четкость линий. Чтобы получить файл меньшего объема, сохраняйте его в форматах WebP или JPEG с высоким качеством сжатия."
  faq5q: "Можно ли задать точные размеры в пикселях?"
  faq5a: "Да. Переключитесь в режим «Произвольный размер» и введите нужные ширину и высоту в пикселях. Активируйте галочку «Сохранять пропорции» для автоматического пересчета второго параметра."
  uploadHint: "Поддерживаются форматы JPG, PNG, WebP, GIF и др."
  original: "Исходный"
  chooseMode: "Выберите режим изменения размера"
  modePreset: "Шаблоны размеров"
  modeCustom: "Произвольный размер"
  modePercentage: "В процентах"
  chooseCategory: "Выберите категорию"
  chooseSize: "Выберите итоговый размер"
  choosePercentage: "Выберите процент"
  width: "Ширина (пикс.)"
  height: "Высота (пикс.)"
  lockRatio: "Сохранять пропорции"
  result: "Результат"
  chooseFormat: "Выберите формат сохранения"
  format: "Формат"
  highQuality: "максимальное качество"
  smallerSize: "меньший размер файла"
  modern: "современный формат"
  quality: "Качество"
  download: "Скачать"
  restart: "Начать заново"
  processing: "Обработка..."
  previewNote: "Файл для скачивания будет создан с указанными размерами."
  see1: "Обрезка изображений"
  see2: "Генератор QR-кодов"
  see3: "Доминантные цвета изображения"
  see4: "Генератор штрихкодов"
</i18n>
