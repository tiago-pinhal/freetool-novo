...
defineI18nRoute({
  paths: {
    ...
    nl: '/toekomstige-datum-calculator',
    ru: '/kalkulyator-budushey-daty'
  },
})
</script>
...
<i18n lang="yaml">
{
  en: {
    ...
    pageTitle: "Future Date Calculator — Add Days to a Date (Plus Weeks, Months and Years)",
    meta: "Free online future date calculator. Add days to a date, plus any combination of weeks, months and years — with optional hours, minutes and seconds — and get the result instantly.",
    mode_date: "Date",
  ...
  pt: {
    ...
    pageTitle: "Calculadora de Data Futura — Somar Dias em Datas (Semanas, Meses e Anos)",
    meta: "Calculadora de data futura online e gratuita para somar dias em datas. Adicione qualquer combinação de dias, semanas, meses e anos — com horas, minutos e segundos opcionais — e calcule a data futura instantaneamente.",
    mode_date: "Data",
  ...
  es: {
    ...
    pageTitle: "Calculadora de Fecha Futura — Sumar Días a una Fecha (Semanas, Meses y Años)",
    meta: "Calculadora de fechas online y gratuita para sumar días a una fecha. Añade cualquier combinación de días, semanas, meses y años — con horas, minutos y segundos opcionales — y calcula la fecha futura al instante.",
    mode_date: "Fecha",
  ...
  fr: {
    ...
    pageTitle: "Calculer une Date Future — Ajouter des Jours à une Date (Semaines, Mois, Années)",
    meta: "Calculatrice de date en ligne et gratuite pour calculer une date future. Ajoutez des jours à une date, avec semaines, mois et années — et heures, minutes et secondes en option — et obtenez le résultat instantanément.",
    mode_date: "Date",
  ...
  it: {
    ...
    pageTitle: "Calcolare Data Futura — Aggiungere Giorni a una Data (Settimane, Mesi e Anni)",
    meta: "Calcolatrice di data online e gratuita per calcolare una data futura. Aggiungi giorni a una data, con settimane, mesi e anni — più ore, minuti e secondi opzionali — e ottieni il risultato istantaneamente.",
    mode_date: "Data",
  ...
  id: {
    ...
    pageTitle: "Kalkulator Tanggal Masa Depan — Menghitung Tanggal: Tambah Hari, Minggu, Bulan atau Tahun",
    meta: "Kalkulator tanggal online gratis untuk menghitung tanggal masa depan. Tambahkan kombinasi hari, minggu, bulan, dan tahun — dengan jam, menit, dan detik opsional — ke tanggal mana pun dan dapatkan hasilnya seketika.",
    mode_date: "Tanggal",
  ...
  de: {
    title: "Zukunftsdatum-Rechner",
    pageTitle: "Datum Rechner — Zukünftiges Datum berechnen: Tage plus Wochen, Monate oder Jahre addieren",
    meta: "Kostenloser Online-Datum-Rechner, um ein zukünftiges Datum zu berechnen. Addieren Sie Tage zu einem Datum — plus Wochen, Monate und Jahre, optional auch Stunden, Minuten und Sekunden — und erhalten Sie das Ergebnis sofort.",
    mode_date: "Datum",
  ...
  nl: {
    title: "Calculator voor toekomstige datum",
    pageTitle: "Datum berekenen — Dagen, weken, maanden of jaren optellen bij een datum",
    meta: "Gratis online tool om een datum te berekenen. Tel dagen, weken, maanden en jaren op bij een datum — met optionele uren, minuten en seconden — en krijg direct de toekomstige datum als resultaat.",
    mode_date: "Datum",
    ...
    how_desc: "Onze calculator voor toekomstige datums vereenvoudigt het berekenen van deadlines door tijdsintervallen aan elke datum toe te voegen. Krijg direct exacte resultaten voor het toevoegen van dagen, weken of jaren, met optionele ondersteuning voor uren en seconden voor zeer nauwkeurige planning. De ideale tool voor het beheren van tijdlijnen, contractvervaldata en leveringslogistiek.",
    features_title: "Functies",
    f_1: "Voeg dagen, weken, maanden en jaren toe aan elke datum",
    f_2: "De modus Datum en tijd voegt uren, minuten en seconden toe",
    f_3: "Resultaat opgemaakt in de taal van uw browser",
    use_cases_title: "Belangrijkste toepassingen",
    use_1_t: "Projectmanagement",
    use_1_d: "Stel leveringsdata vast door week- of maand-sprints toe te voegen aan de startdatum van het project.",
    use_2_t: "Contractbeheer",
    use_2_d: "Bereken exacte vervaldatums op basis van de duur (bijv. 12 of 24 maanden) vanaf de ondertekeningsdatum.",
    use_3_t: "Logistiek en leveringen",
    use_3_d: "Bepaal maximale levertermijnen door kalenderdagen toe te voegen aan de verzend- of aankoopdatum.",
    how_to_use_title: "Hoe deze tool te gebruiken",
    step_1_title: "Kies een modus",
    step_1_desc: "Selecteer Datum voor een resultaat alleen met datum, of Datum en tijd om ook uren, minuten en seconden mee te nemen.",
    step_2_title: "Stel een startdatum in",
    step_2_desc: "Voer de basisdatum in (en tijd, indien van toepassing) vanaf welke u wilt berekenen.",
    step_3_title: "Voeg een interval toe",
    step_3_desc: "Vul een of meer offsetvelden in en het resultaat wordt automatisch bijgewerkt.",
    ex_title: "Veelvoorkomende voorbeelden",
    ex1: "Contract van 6 maanden: ondertekening op 1 maart → vervaldatum op 1 september.",
    ex2: "Retourbeleid van 90 dagen: aankoop op 10 januari → deadline op 10 april.",
    ex3: "Projectsprint van 3 weken: start op maandag 5 mei → einde op zondag 25 mei.",
    faq_title: "Vragen en Antwoorden",
    faq1q: "Kan ik meer dan één eenheid tegelijk toevoegen?",
    faq1a: "Ja. Vul zoveel offsetvelden in als u nodig hebt, bijvoorbeeld 1 jaar en 3 maanden tegelijk, en de calculator combineert ze allemaal.",
    faq2q: "Houdt de calculator rekening met schrikkeljaren?",
    faq2a: "Ja. 1 jaar toevoegen aan 29 februari 2024 geeft correct 28 februari 2025.",
    faq3q: "Wat voegt de modus Datum en tijd toe?",
    faq3a: "In de modus Datum en tijd kunt u naast elke dag-, week-, maand- of jaaroffset ook uren, minuten en seconden toevoegen.",
    see1: "Tijdsverschilcalculator",
    see2: "Tijdsverschilcalculator (datum & tijd)",
    see3: "Verleden datum-calculator",
    see4: "Uren- en minuten-calculator"
  },
  ru: {
    title: "Калькулятор будущей даты",
    pageTitle: "Калькулятор будущей даты — Прибавить дни, недели, месяцы и годы к дате",
    meta: "Бесплатный онлайн-калькулятор будущей даты. Прибавляйте к дате дни, недели, месяцы и годы (а также часы, минуты и секунды по желанию) и мгновенно получайте результат.",
    mode_date: "Дата",
    ...
    how_desc: "Наш калькулятор будущей даты упрощает расчет сроков, позволяя прибавлять любые временные интервалы к выбранной дате. Мгновенно прибавляйте дни, недели, месяцы или годы с возможностью дополнительного ввода часов, минут и секунд для высокоточного планирования. Это идеальный инструмент для управления графиками, отслеживания окончания договоров и планирования логистики поставок.",
    features_title: "Возможности",
    f_1: "Добавление дней, недель, месяцев и лет к любой дате",
    f_2: "Режим «Дата и время» для точного сложения часов, минут и секунд",
    ...
    use_1_t: "Управление проектами",
    use_1_d: "Устанавливайте даты сдачи этапов, прибавляя рабочие спринты в неделях или месяцах к дате начала проекта.",
    use_2_t: "Контроль договоров",
    use_2_d: "Рассчитывайте точные даты истечения действия контрактов на основе их продолжительности (например, 12 или 24 месяца) от даты подписания.",
    use_3_t: "Логистика и доставка",
    use_3_d: "Определяйте крайние сроки доставки товаров, прибавляя календарные дни к дате отправки или покупки.",
    ...
    step_2_title: "Укажите начальную дату",
    step_2_desc: "Введите базовую дату (и время, при необходимости), от которой вы хотите вести отсчет.",
    step_3_title: "Прибавьте интервал",
    ...
    ex1: "Договор на 6 месяцев: подписание 1 марта → истечение срока 1 сентября.",
    ex2: "Срок возврата товара в 90 дней: покупка 10 января → крайний срок 10 апреля.",
    ex3: "Спринт проекта длительностью 3 недели: старт в понедельник 5 мая → окончание в воскресенье 25 мая.",
    faq_title: "Вопросы и ответы",
    faq1q: "Можно ли прибавлять несколько разных единиц времени одновременно?",
    faq1a: "Да. Вы можете заполнить сколько угодно полей (например, прибавить 1 год и 3 месяца одновременно), и калькулятор объединит все эти смещения.",
    faq2q: "Учитывает ли калькулятор високосные года?",
    faq2a: "Да. Например, прибавление 1 года к дате 29 февраля 2024 года корректно выдаст результат 28 февраля 2025 года.",
    faq3q: "Что именно добавляет режим «Дата и время»?",
    faq3a: "В режиме «Дата и время» вы можете прибавлять часы, минуты и секунды в дополнение к любым смещениям в днях, неделях, месяцах или годах.",
    see1: "Разница во времени",
    see2: "Разница между датами и временем",
    see3: "Калькулятор прошедшей даты",
    see4: "Калькулятор часов и минут"
  }
}
</i18n>
