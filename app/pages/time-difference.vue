...
<i18n lang="yaml">
{
  ...
  ru: {
    title: "Разница между часами",
    pageTitle: "Калькулятор разницы во времени — Рассчитать время между двумя часами | Бесплатно",
    meta: "Рассчитайте точную разницу между двумя значениями времени в часах и минутах, а также общее прошедшее время в минутах. Бесплатно, без регистрации.",
    param1: "Время начала",
    param2: "Время окончания",
    diff: "Разница",
    or: "Или эквивалентно…",
    hours_label: "Часы",
    minutes_label: "Минуты",
    total_minutes_label: "Всего в минутах",
    eq: "Пожалуйста, введите два разных времени для расчета разницы",
    features_title: "Возможности",
    f_1: "Точный расчет в часах и минутах",
    f_2: "Общее прошедшее время в минутах",
    f_3: "Автоматическое исправление порядка времени",
    f_4: "Работает с любыми двумя значениями времени в течение суток",
    how_desc: "Введите время начала и окончания. Калькулятор мгновенно покажет точную разницу в часах и минутах, а также общий эквивалент в минутах. Идеально подходит для отслеживания рабочих смен, учебных занятий, тренировок и любой другой временной активности.",
    use_cases_title: "Основные применения",
    use_1_t: "Работа и учеба",
    use_1_d: "Рассчитайте, сколько времени вы потратили на конкретную задачу или учебную сессию, чтобы оптимизировать свою продуктивность.",
    use_2_t: "Тренировки",
    use_2_d: "Точно отслеживайте продолжительность тренировок и кардио-активностей.",
    use_3_t: "События и встречи",
    use_3_d: "Организуйте свой день, рассчитывая интервалы между делами и запланированными встречами.",
    use_4_t: "Отслеживание смен",
    use_4_d: "Быстро узнайте, сколько часов и минут длилась рабочая смена для расчета зарплаты или личных записей.",
    use_5_t: "Расчет стоимости",
    use_5_d: "Рассчитайте оплачиваемые часы между началом и окончанием работы для клиентов и фриланс-проектов.",
    use_6_t: "Путешествия",
    use_6_d: "Измеряйте продолжительность поездок, зная время отправления и прибытия.",
    how_to_use_title: "Как пользоваться этим инструментом",
    step_1_title: "Введите время начала",
    step_1_desc: "Нажмите на поле «Время начала» и введите или выберите стартовое время.",
    step_2_title: "Введите время окончания",
    step_2_desc: "Нажмите на поле «Время окончания» и выберите второе время. Результаты появятся мгновенно.",
    step_3_title: "Прочитайте результаты",
    step_3_desc: "Разбивка показывает разницу в часах и минутах. Ниже вы увидите общий эквивалент в минутах.",
    ex_title: "Популярные примеры",
    ex1: "Рабочая сессия: с 09:00 до 17:30 — 8 часов и 30 минут, или 510 минут всего.",
    ex2: "Тренировка: с 06:15 до 07:00 — 45 минут.",
    ex3: "Блок учебы: с 14:00 до 16:45 — 2 часа и 45 минут, или 165 минут всего.",
    ex4: "Ночная смена: с 22:00 до 06:00 — 8 часов.",
    faq_title: "Вопросы и ответы",
    faq1q: "В чем разница между этим инструментом и Калькулятором разницы дат и времени?",
    faq1a: "Этот инструмент работает только со временем (без даты). Калькулятор разницы дат и времени принимает как дату, так и время, позволяя рассчитывать интервалы, охватывающие несколько дней.",
    faq2q: "Что произойдет, если я введу время окончания раньше времени начала?",
    faq2a: "Инструмент автоматически рассчитывает абсолютную разницу, поэтому порядок не имеет значения. Вы всегда получите положительный результат.",
    faq3q: "Могу ли я рассчитать ночные смены, переходящие через полночь?",
    faq3a: "Да. Поскольку инструмент вычисляет абсолютную разницу между двумя значениями времени, он работает правильно независимо от их порядка: введите 22:00 и 06:00, и вы получите 8 часов.",
    see1: "Генератор даты рождения",
