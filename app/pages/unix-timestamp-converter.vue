...
<i18n lang="yaml">
{
  en: {
    ...
    pageTitle: "Epoch Converter — Unix Timestamp to Date Online (Seconds & Milliseconds) | Free",
    meta: "Free online epoch converter and Unix timestamp tool. Convert timestamps to dates in any timezone, dates to timestamps, in seconds or milliseconds. Includes JWT expiry calculator and shareable URLs.",
  ...
  pt: {
    ...
    pageTitle: "Timestamp para Data — Conversor Unix Epoch Online (Segundos e Milissegundos) | Grátis",
    meta: "Conversor de timestamp para data online grátis. Converta timestamps Unix em datas em qualquer fuso horário, ou datas em timestamps, em segundos ou milissegundos. Inclui cálculo de expiração de JWT e TTL de cache.",
  ...
  es: {
    ...
    pageTitle: "Timestamp a Fecha — Convertidor Unix Epoch en Línea (Segundos y Milisegundos) | Gratis",
    meta: "Convertidor de timestamp a fecha gratuito en línea. Convierte timestamps Unix a fechas en cualquier zona horaria, o fechas a timestamps, en segundos o milisegundos. Incluye cálculo de expiración JWT y URLs compartibles.",
  ...
  fr: {
    ...
    pageTitle: "Timestamp en Date — Convertisseur Unix Epoch en Ligne (Secondes et Millisecondes) | Gratuit",
    meta: "Convertisseur de timestamp en date gratuit en ligne. Convertissez des timestamps Unix en dates dans n'importe quel fuseau horaire, ou des dates en timestamps, en secondes ou millisecondes. Calcul d'expiration JWT et URLs partageables inclus.",
  ...
  it: {
    ...
    pageTitle: "Timestamp Unix in Data — Convertitore Epoch Online (Secondi e Millisecondi) | Gratuito",
    meta: "Convertitore di timestamp Unix in data online gratuito. Converti timestamp in date leggibili in qualsiasi fuso orario, o date in timestamp, in secondi o millisecondi. Include calcolo della scadenza JWT e URL condivisibili.",
  ...
  de: {
    ...
    pageTitle: "Unix Zeitstempel umrechnen — Timestamp zu Datum online (Sekunden & Millisekunden) | Kostenlos",
    meta: "Unix Zeitstempel kostenlos online umrechnen. Konvertieren Sie Timestamps in lesbare Datumsangaben in jeder Zeitzone, oder Datumsangaben in Timestamps, in Sekunden oder Millisekunden. Mit JWT-Ablaufberechnung und teilbaren URLs.",
  ...
  nl: {
    title: "Unix Timestamp-converter",
    pageTitle: "Unix Timestamp-converter — Epoch-tijd online omzetten | Gratis",
    meta: "Gratis online Unix timestamp-converter. Converteer timestamps naar leesbare datums in elke tijdzone, zet datums om naar timestamps en voer tijdrekenkunde uit voor JWT-verloop, cache-TTL en meer.",
    live_s: "Huidige Epoch (seconden)",
    live_ms: "Huidige Epoch (milliseconden)",
    ts_to_date: "Timestamp naar Datum",
    date_to_ts: "Datum naar Timestamp",
    arithmetic_title: "Timestamp-berekening",
    arithmetic_intro: "Tel tijd op of trek tijd af van elke timestamp. Bereken JWT-verloop, cache-TTL, sessie-timeouts en geplande jobvensters. Werkt met zowel seconden als milliseconden.",
    label_ts: "Voer Unix-timestamp in",
    detected: "Gedetecteerde eenheid",
    s: "Seconden",
    ms: "Milliseconden",
    gmt: "GMT / UTC",
    local: "Je lokale tijd",
    iso: "ISO 8601",
    sql: "SQL / MySQL (UTC)",
    relative: "Relatief",
    timezone: "Tijdzone",
    ...
    base_ts_label: "Basis-timestamp",
    use_now: "Gebruik nu",
    delta_label: "Optellen / Aftrekken",
    delta_hint: "Gebruik negatieve waarden om terug in de tijd te gaan.",
    just_now: "Zojuist",
    past_format: "{time} geleden",
    future_format: "over {time}",
    days: "dagen",
    hours: "uren",
    min_short: "min",
    s_short: "sec",
    how_desc: "Converteer Unix-timestamps naar leesbare datums in elke tijdzone, of zet een datum om naar een timestamp. Seconden en milliseconden worden automatisch gedetecteerd. Gebruik de rekenmodule om JWT-verloop, cache-TTL of sessievensters te berekenen, en deel elke timestamp via URL in één klik.",
    features_title: "Functies",
    f_1: "Automatische detectie van timestamp-precisie (seconden of milliseconden)",
    f_2: "Tijdzonebewuste weergave in meer dan 30 tijdzones wereldwijd",
    f_3: "Timestamp-berekeningen: dagen, uren, minuten en seconden optellen of aftrekken",
    f_4: "Uitvoer in meerdere formaten: UTC, lokale tijd, ISO 8601, SQL en relatief",
    f_5: "Converteer elke datum terug naar Unix Epoch in seconden of milliseconden",
    f_6: "Deelbare URL's — stuur een timestamp naar een collega in één klik",
    use_cases_title: "Belangrijkste toepassingen",
    use_1_t: "API-foutopsporing",
    use_1_d: "Decodeer timestamps van API-responses en serverlogs direct om tijdlijnen te begrijpen.",
    use_2_t: "JWT-verloop",
    use_2_d: "Bereken token-verlooptijden nauwkeurig met de rekenmachine om authenticatieproblemen te voorkomen.",
    use_3_t: "Databasewerk",
    use_3_d: "Converteer tussen SQL datetime strings en Unix-timestamps voor queries en migrations.",
    use_4_t: "Planning",
    use_4_d: "Plan toekomstige evenementen en cronjobs door exacte timestamps voor elke tijdzone te berekenen.",
    use_5_t: "Loganalyse",
    use_5_d: "Koppel gebeurtenissen in gedistribueerde systemen door log-timestamps naar een gemeenschappelijke referentie om te zetten.",
    use_6_t: "Team-samenwerking",
    use_6_d: "Deel timestamp-links zodat collega's in verschillende tijdzones de juiste lokale tijd zien.",
    how_to_use_title: "Hoe deze tool te gebruiken",
    step_1_title: "Voer een timestamp in of controleer deze",
    step_1_desc: "Plak een Unix-timestamp in het veld 'Timestamp naar Datum' — seconden en milliseconden worden automatisch gedetecteerd.",
    step_2_title: "Kies een tijdzone",
    step_2_desc: "Selecteer de tijdzone van uw voorkeur om de geconverteerde datum in die regio te zien.",
    step_3_title: "Gebruik de rekenmodule",
    step_3_desc: "Voer een basis-timestamp in en tel dagen, uren, minuten of seconden op of trek ze af om een toekomstige of eerdere timestamp te berekenen.",
    faq_title: "Vragen en Antwoorden",
    faq1q: "Wat is een Unix-timestamp?",
    faq1a: "Een Unix-timestamp is het aantal seconden dat is verstreken sinds 1 januari 1970 00:00:00 UTC (de Unix Epoch), exclusief schrikkelseconden. Het is de standaard tijdweergave voor de meeste besturingssystemen, databases en API's.",
    faq2q: "Wat is het verschil tussen timestamps in seconden en milliseconden?",
    faq2a: "Een 10-cijferige timestamp is in seconden; een 13-cijferige timestamp is in milliseconden. Deze tool detecteert de precisie automatisch, maar u kunt altijd het label onder het invoerveld controleren.",
    faq3q: "Kan deze tool datums voor 1970 aan?",
    faq3a: "Ja. Negatieve timestamps vertegenwoordigen datums voor de Unix Epoch. Bijvoorbeeld, -86400 komt overeen met 31 december 1969 om 00:00:00 UTC.",
  ...
  ru: {
    title: "Конвертер Timestamp Unix",
    pageTitle: "Конвертер Epoch — Перевод Unix Timestamp в Дату Онлайн (Секунды и Миллисекунды) | Бесплатно",
    meta: "Бесплатный онлайн-конвертер Epoch и инструмент для работы с Unix-таймстампами. Конвертируйте таймстампы в даты в любом часовом поясе, даты в таймстампы в секундах или миллисекундах. Включает калькулятор истечения JWT и кэша TTL.",
    live_s: "Текущий Epoch (Секунды)",
    live_ms: "Текущий Epoch (Миллисекунды)",
    ts_to_date: "Таймстамп в Дату",
    date_to_ts: "Дата в Таймстамп",
    arithmetic_title: "Арифметика Таймстампов",
    arithmetic_intro: "Сложение и вычитание времени из любого таймстампа. Вычисляйте срок действия JWT, TTL кэша, тайм-ауты сессий и интервалы запланированных задач. Работает как с секундами, так и с миллисекундами.",
    label_ts: "Введите Unix Timestamp",
    detected: "Обнаруженная единица",
    s: "Секунды",
    ms: "Миллисекунды",
    gmt: "GMT / UTC",
    local: "Ваше местное время",
    iso: "ISO 8601",
    sql: "SQL / MySQL (UTC)",
    ...
    mn: "Мин",
    sc: "Сек",
    ts_s: "Unix Timestamp (с)",
    ts_ms: "Unix Timestamp (мс)",
    base_ts_label: "Базовый таймстамп",
    use_now: "Использовать текущее",
    delta_label: "Сложить / Вычесть",
    delta_hint: "Используйте отрицательные значения для возврата в прошлое.",
    just_now: "Только что",
    past_format: "{time} назад",
    future_format: "через {time}",
    days: "дней",
    hours: "часов",
    min_short: "мин",
    s_short: "сек",
    how_desc: "Конвертируйте таймстампы Unix в читаемые даты в любом часовом поясе или конвертируйте любую дату обратно в таймстамп. Секунды и миллисекунды определяются автоматически. Используйте раздел арифметики для расчета срока действия JWT, TTL кэша или окон сессий, а также делитесь любым таймстампом через URL в один клик.",
    features_title: "Возможности",
    f_1: "Автоматическое определение точности таймстампа (секунды или миллисекунды)",
    f_2: "Отображение с учетом часового пояса в более чем 30 зонах по всему миру",
    f_3: "Арифметика таймстампов: сложение или вычитание дней, часов, минут и секунд",
    f_4: "Вывод в нескольких форматах: UTC, местное время, ISO 8601, SQL и относительное время",
    f_5: "Конвертация любой даты обратно в Unix Epoch в секундах или миллисекундах",
    f_6: "Ссылки для обмена — отправьте таймстамп коллеге в один клик",
    use_cases_title: "Основные области применения",
    use_1_t: "Отладка API",
    use_1_d: "Мгновенно декодируйте таймстампы из ответов API и серверных логов для понимания хронологии событий.",
    use_2_t: "Срок действия JWT",
    use_2_d: "Точно рассчитывайте время истечения токенов с помощью арифметического калькулятора, чтобы избежать проблем с авторизацией.",
    use_3_t: "Работа с базами данных",
    use_3_d: "Конвертируйте строки даты и времени SQL в таймстампы Unix и обратно для запросов и миграций.",
    use_4_t: "Планирование задач",
    use_4_d: "Планируйте будущие события и задачи cron, рассчитывая точные таймстампы для любого часового пояса.",
    use_5_t: "Анализ логов",
    use_5_d: "Сопоставляйте события в распределенных системах, конвертируя таймстампы логов в общий ориентир.",
    use_6_t: "Командная работа",
    use_6_d: "Делитесь ссылками на таймстампы, чтобы коллеги в разных часовых поясах видели правильное местное время.",
    how_to_use_title: "Как пользоваться этим инструментом",
    step_1_title: "Введите или проверьте таймстамп",
    step_1_desc: "Вставьте Unix-таймстамп в поле «Таймстамп в Дату» — секунды и миллисекунды определятся автоматически.",
    step_2_title: "Выберите часовой пояс",
    step_2_desc: "Выберите нужный часовой пояс, чтобы увидеть сконвертированную дату в этом регионе.",
    step_3_title: "Используйте раздел арифметики",
    step_3_desc: "Введите базовый таймстамп и прибавьте или вычтите дни, часы, минуты или секунды для расчета будущего или прошлого таймстампа.",
    faq_title: "Вопросы и ответы",
    faq1q: "Что такое таймстамп Unix?",
    faq1a: "Таймстамп Unix — это количество секунд, прошедших с 1 января 1970 года 00:00:00 UTC (Unix Epoch), без учета високосных секунд. Это стандартное представление времени, используемое большинством операционных систем, баз данных и API.",
    faq2q: "В чем разница между таймстампами в секундах и миллисекундах?",
    faq2a: "10-значный таймстамп измеряется в секундах; 13-значный — в миллисекундах. Этот инструмент автоматически определяет точность, но вы всегда можете проверить метку под полем ввода.",
    faq3q: "Поддерживает ли этот инструмент даты до 1970 года?",
    faq3a: "Да. Отрицательные таймстампы представляют даты до Unix Epoch. Например, -86400 соответствует 31 декабря 1969 года 00:00:00 UTC.",
    see1: "Инструменты даты и времени",
    see2: "Конвертер времени",
    see3: "Генератор Crontab",
    see4: "Генератор UUID"
  }
}
</i18n>
